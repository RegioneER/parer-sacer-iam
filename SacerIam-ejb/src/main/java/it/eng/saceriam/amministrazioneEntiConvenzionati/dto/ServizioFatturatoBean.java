...
public class ServizioFatturatoBean extends BaseRow {
    ...
    public ServizioFatturatoBean(long id_fattura_ente, long id_servizio_erogato,
	    String nm_servizio_erogato, BigDecimal aa_servizio_fattura, String tipo_fatturazione,
	    String nm_tariffa, BigDecimal im_valore_tariffa, String cd_tipo_servizio,
	    String nm_sistema_versante, String fl_pagamento, Date dt_erog,
	    BigDecimal qt_scaglione_servizio_fattura, BigDecimal im_servizio_fattura,
	    String tipo_tariffa) {
