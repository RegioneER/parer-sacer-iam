...
public class EntiConvenzionatiHelper extends GenericHelper {
    ...
    public List<OrgAmbitoTerrit> retrieveOrgAmbitoTerritChildList(
        ...
        // TODO: Bisogna chiedere a Sandro di fare un sinonimo per questa tabella, cosÃ¬ non
        // romperÃ  piÃ¹ le palle per
    ...
    public OrgEnteSiam getOrgEnteConvenz(String nmEnteConvenz) {
        ...
        if (StringUtils.isNotBlank(nmEnteConvenz)) {
            Query query = getEntityManager().createQuery(
                    "SELECT ente FROM OrgEnteSiam ente WHERE ente.nmEnteSiam = :nmEnteConvenz");
     ...
     * Ritorna l'oggetto ente convenzionato se esiste
     *
     * @param cdEnteConvenz   codice ente
     * @param tiCdEnteConvenz tipo codice ente
     *
     * @return l'entity richiesta se esiste, oppure <code>null</code>
     */
    public OrgEnteSiam getOrgEnteConvenz(String cdEnteConvenz, String tiCdEnteConvenz) {
        ...
        Query query = getEntityManager().createQuery(
                "SELECT ente FROM OrgEnteSiam ente " + "WHERE ente.cdEnteConvenz = :cdEnteConvenz "
                        + "AND ente.tiCdEnteConvenz = :tiCdEnteConvenz ");
     ...
     *
     * @param idEnteConvenzDaEscludere id ente convenzionato da escludere
     *
     ...
     *
     * @param tiEnteConvenz ente convenzionato di tipo {@link TiEnteConvenz}
     *
     * @return lista elementi di tipo {@link OrgEnteSiam}
     */
    public List<OrgEnteSiam> getOrgEnteConvenzList(
     ...
     */
    public List<OrgAmbienteEnteConvenz> getOrgAmbienteEnteConvenzList(
            ConstOrgEnteSiam.TiEnteConvenz tiEnteConvenz) {
    ...
    /**
     * Ritorna la lista degli enti convenzionati dei tipi passati in input cui l'utente corrente
    ...
    /**
     * Ritorna la lista degli ambienti enti convenzionati in base ai tipi ente convenzionato passati
     * in input cui l'utente corrente è abilitato
     *
     * @param idUserIamCor  id user iam
     * @param tiEnteConvenz ente convenzionato di tipo {@link TiEnteConvenz}
     *
     * @return lista elementi di tipo {@link OrgAmbienteEnteConvenz}
     */
    public List<OrgAmbienteEnteConvenz> getOrgAmbienteEnteConvenzUserAbilList(
    ...
    /**
     * Ritorna la lista degli enti convenzionati collegati all'ente passato in input (escluso se
     * stesso) cui l'utente corrente è abilitato
     *
     * @param idUserIamCor  id user IAM
     ...
     * @return lista elementi di tipo {@link OrgEnteSiam}
     */
    public List<OrgEnteSiam> getOrgEnteConvenzCollegUserAbilList(BigDecimal idUserIamCor,
        ...
        String queryStr = "SELECT appart2.orgEnteSiam FROM UsrVAbilEnteConvenz abilEnteConvenz, OrgEnteSiam ente, "
                ...
                + "AND appart2.orgEnteSiam <> appart1.orgEnteSiam "
                + "AND ente.idEnteSiam = :idEnteConvenz " + "ORDER BY ente.nmEnteSiam";
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idUserIamCor", idUserIamCor);
     ...
     * @param idEnteConvenzExcluded id ente da escludere
     *
     * @return lista elementi di tipo {@link OrgEnteSiam}
     */
    ...
    /**
     * Ritorna la lista degli utenti appartenenti ad enti (diversi da quello aggiunto al
     * collegamento) coinvolti nel collegamento, per i quali è settato l'indicatore che deve essere
     * abilitato in automatico agli enti produttori appartenenti ai collegamenti
     * (fl_abil_enti_colleg_autom)
     *
     * @param idCollegEntiConvenz   id ente collegamento enti convezionati
     * @param idEnteConvenzExcluded id ente convenzionato da escludere
     *
     * @return lista elementi di tipo {@link UsrUser}
     */
    public List<UsrUser> getUsrUserCollegList(BigDecimal idCollegEntiConvenz,
            BigDecimal idEnteConvenzExcluded) {
    ...
    public List<OrgCollegEntiConvenz> retrieveOrgCollegEntiConvenz(BigDecimal idUserIamCor,
            String nmColleg, String dsColleg, Date dtValidDa, Date dtValidA) {
    ...
    public List<OrgSuptEsternoEnteConvenz> retrieveOrgSuptEsternoEnteConvenz(
            BigDecimal idEnteConvenz, String tiEnteNonConvenz) {
        ...
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
        query.setParameter("tiEnteNonConvenz",
                ConstOrgEnteSiam.TiEnteNonConvenz.valueOf(tiEnteNonConvenz));
    ...
    public List<OrgVRicEnteConvenz> retrieveOrgEnteConvenzList(String nmEnteConvenz,
            ...
            String noArchivista, String flRicev, String flRichModuloInfo, String flNonConvenz,
        ...
        String clause = " WHERE ";
        // Ottengo la lista di tutti gli id di ambito territoriale da ricercare, che corrispondono
        // all'intera gerarchia
        // di dati selezionati
        List<BigDecimal> idAmbitoTerritList = getIdAmbitoTerritorialePerRicerca(
        ...
        if (dtDecAccordoDa != null && dtDecAccordoA != null) {
            queryStr.append(clause)
                    .append("(ente.dtDecAccordo BETWEEN :dtDecAccordoDa AND :dtDecAccordoA) ");
            clause = " AND ";
        }

        if (dtFineValidAccordoDa != null && dtFineValidAccordoA != null) {
            queryStr.append(clause).append(
                    "(ente.dtFineValidAccordo BETWEEN :dtFineValidAccordoDa AND :dtFineValidAccordoA) ");
            clause = " AND ";
        }

        if (dtDecAccordoInfoDa != null && dtDecAccordoInfoA != null) {
            queryStr.append(clause).append(
                    "(ente.dtDecAccordoInfo BETWEEN :dtDecAccordoInfoDa AND :dtDecAccordoInfoA) ");
            clause = " AND ";
        }

        if (dtScadAccordoDa != null && dtScadAccordoA != null) {
            queryStr.append(clause)
                    .append("(ente.dtScadAccordo BETWEEN :dtScadAccordoDa AND :dtScadAccordoA) ");
            clause = " AND ";
        }
        ...
        if (dtCessazioneDa != null && dtCessazioneA != null) {
            queryStr.append(clause)
                    .append("(ente.dtCessazione BETWEEN :dtCessazioneDa AND :dtCessazioneA) ");
            clause = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(tiStatoAccordo)) {
            // MAC#22374
            if (tiStatoAccordo.equals("Accordo valido")
                    || tiStatoAccordo.equals("Accordo non valido")) {
    ...
    private List<BigDecimal> getIdAmbitoTerritorialePerRicerca(List<BigDecimal> regioniList,
        ...
        if (!provinceList.isEmpty()) {
            // Controllo se ci sono figli selezionati nell'online: se non ci sono piazzo la
            // provincia e tutti i suoi
            // figli
    ...
    private boolean haFigliPresentiInSottoLivelloOnlineList(BigDecimal idPadre,
        ...
        // Se la lista di figli presenti nell'online Ã¨ vuota, Ã¨ ovvio che non avrÃ² figli presenti
        // nell'online
        if (figliQualunquePresentiInOnline.isEmpty()) {
            ...
            query.setParameter("figliQualunquePresentiInOnline",
                    longListFrom(figliQualunquePresentiInOnline));
    ...
    public boolean esisteModelloInfoPerDataIdentificativo(BigDecimal idAccordoEnte,
            String cdModuloInfo, String cdRegistroModuloInfo, BigDecimal aaModuloInfo,
            String cdKeyModuloInfo) {
        StringBuilder queryStr = new StringBuilder("SELECT a FROM OrgModuloInfoAccordo a "
                + "WHERE a.orgAccordoEnte.idAccordoEnte = :idAccordoEnte ");
    ...
    public boolean esisteModelloInfoPerDataIdentificativoEnteConvenz(BigDecimal idEnteConvenz,
            String cdModuloInfo, String cdRegistroModuloInfo, BigDecimal aaModuloInfo,
            String cdKeyModuloInfo) {
        StringBuilder queryStr = new StringBuilder("SELECT a FROM OrgModuloInfoAccordo a "
                + "WHERE a.orgEnteConvenz.idEnteSiam = :idEnteConvenz ");
     ...
     */
    public List<OrgStoEnteAmbienteConvenz> retrieveOrgStoEnteAmbienteConvenz(
            BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery(
     ...
     *
     * @param idUserIamCor  id uesr IAM
     * @param idEnteConserv id ente conservatore
     * @param isValid       true se valido
     * @param tiEnteConvenz tipo ente {@link TiEnteConvenz}
     *
     * @return la lista di accordi
     */
    public List<OrgAccordoEnte> retrieveOrgAccordoEnteGestore(BigDecimal idUserIamCor,
            BigDecimal idEnteConserv, boolean isValid, TiEnteConvenz... tiEnteConvenz) {
        StringBuilder queryStr = new StringBuilder(
        ...
        queryStr.append(clause)
                .append("EXISTS (SELECT accordo_ente FROM OrgAccordoEnte accordo_ente "
        ...
        queryStr.append(clause).append(
                "accordoGestore.orgEnteSiamByIdEnteConvenzConserv.idEnteSiam = :idEnteConserv ");
    ...
    public List<OrgVRicEnteConvenz> getOrgVRicEnteConvenzList(BigDecimal idUserIamCor,
            String tiEnteConvenz) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT ricEnteConvenz FROM OrgVRicEnteConvenz ricEnteConvenz "
    ...
    public List<OrgEnteSiam> getEnteConvenzConservList(BigDecimal idUserIamCor,
    ...
    /**
     * Ritorna la lista degli accordi validi (esclusi quelli dell'ente dato in input) in cui l'ente
     ...
     * @return la lista di accordi
     */
    public List<OrgAccordoEnte> retrieveOrgAccordoEnteValidByTipo(BigDecimal idEnteConvenz,
            String tiEnteConvenz) {
        ...
        case CONSERVATORE:
            queryStr.append(clause).append(
                    "accordo.orgEnteSiamByIdEnteConvenzConserv.idEnteSiam = :idEnteConvenz ");
            clause = "AND ";
            break;
        case GESTORE:
            queryStr.append(clause).append(
                    "accordo.orgEnteSiamByIdEnteConvenzGestore.idEnteSiam = :idEnteConvenz ");
            clause = "AND ";
            break;
        default:
            break;
        ...
        queryStr.append(clause).append(
                "accordo.dtDecAccordo <= :dataOdierna AND accordo.dtFineValidAccordo >= :dataOdierna "
    ...
    /**
     * Ritorna l'accordo più recente per l'ente convenzionato dato in input. Se esiste un accordo
     * con data di decorrenza a NULL, ritorna quest'ultimo.
     *
     * @param idEnteConvenz id ente convenzionato
     *
    ...
    public List<OrgEnteConvenzOrg> retrieveOrgEnteConvenzOrg(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery(
                "SELECT s FROM OrgEnteConvenzOrg s WHERE s.orgEnteSiam.idEnteSiam = :idEnteConvenz");
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
     ...
     *
     * @param idEnteConvenz id ente convenzionato
     * @param filterValid   true se filtro valido
     *
     * @return la lista di strutture
     */
    public List<OrgVEnteConvenzByOrganiz> retrieveOrgVEnteConvenzByOrganiz(BigDecimal idEnteConvenz,
            boolean filterValid) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT organiz FROM OrgVEnteConvenzByOrganiz organiz ");
        ...
        if (filterValid) {
            queryStr.append(whereWord).append(
                    "organiz.dtIniVal <= :filterDate AND organiz.dtFineVal >= :filterDate ");
        }
    ...
    /**
     * Ritorna la lista di associazioni tra la struttura versante e per l'ente convenzionato dati in
     * input
     *
     * @param idEnteConvenz id ente convenzionato
    ...
    public List<OrgEnteConvenzOrg> retrieveOrgEnteConvenzOrg(BigDecimal idEnteConvenz,
        ...
        Query query = getEntityManager().createQuery("SELECT s FROM OrgEnteConvenzOrg s "
                + "WHERE s.orgEnteSiam.idEnteSiam = :idEnteConvenz "
                + "AND s.usrOrganizIam.idOrganizIam = :idOrganizIam "
                + "ORDER BY s.dtIniVal DESC ");
        query.setParameter("idEnteConvenz", idEnteConvenz.longValue());
    ...
    public List<OrgEnteConvenzOrg> retrieveOrgEnteConvenzOrgForOrganiz(BigDecimal idOrganizIam) {
        Query query = getEntityManager().createQuery("SELECT s FROM OrgEnteConvenzOrg s "
                + "WHERE s.usrOrganizIam.idOrganizIam = :idOrganizIam "
                + "ORDER BY s.dtIniVal DESC ");
        query.setParameter("idOrganizIam", idOrganizIam.longValue());
        List<OrgEnteConvenzOrg> list = query.getResultList();
        return list;
    ...
    /**
     * Controlla se esistono dei servizi riferiti ad accordi dellâ€™ente convenzionato giÃ  inseriti
     * in una fattura.
     *
     * @param idEnteConvenz id ente convenzionato
     *
    ...
    public boolean checkEsistenzaServiziInFatturaPerEnteConvenz(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery("SELECT enteSiam FROM OrgEnteSiam enteSiam "
                ...
                + "JOIN servizioErog.orgAccordoEnte accordoEnte "
    ...
    public boolean checkEsistenzaServiziInFatturaPerAccordo(BigDecimal idAccordoEnte) {
        Query query = getEntityManager()
                .createQuery("SELECT accordoEnte FROM OrgAccordoEnte accordoEnte "
    ...
    public boolean checkEsistenzaServiziInFattura(BigDecimal idServizioErogato) {
        Query query = getEntityManager().createQuery(
                "SELECT COUNT(servizioFattura) FROM OrgServizioFattura servizioFattura "
    ...
    /**
     * Controlla che nel periodo compreso tra data di inizio e di fine validitÃ  la struttura
     * versante non sia giÃ  associata ad un altro ente convenzionato ricercando sulla tabella
     * dell'associazione ovvero OrgEnteConvenzOrg
     *
     * @param idOrganizIam                id organizzazione IAM
     * @param dtIniVal                    data inizio validita
     * @param dtFineVal                   data fine validita
     * @param idEnteConvenzOrgDaEscludere eventuale id da non considerare nel controllo, in quanto
     *                                    riferito al record stesso!
     *
     * @return true se esiste già  l'associazione
     */
    public boolean checkEsistenzaAssociazioneEnteConvenzStrutVers(BigDecimal idOrganizIam,
            Date dtIniVal, Date dtFineVal, BigDecimal idEnteConvenzOrgDaEscludere) {
        ...
        if (idEnteConvenzOrgDaEscludere != null) {
            queryStr = queryStr
                    + "AND enteConvenzOrg.idEnteConvenzOrg != :idEnteConvenzOrgDaEscludere ";
        }
        Query query = getEntityManager().createQuery(queryStr);
        ...
        if (idEnteConvenzOrgDaEscludere != null) {
            query.setParameter("idEnteConvenzOrgDaEscludere",
                    longFrom(idEnteConvenzOrgDaEscludere));
        }
        List<OrgEnteConvenzOrg> list = query.getResultList();
        return !list.isEmpty();
    }
    ...
    /**
     * Controlla se esiste almeno un utente avente ente convenzionato di appartenenza uguale
     * all'ente passato in ingresso
     *
     * @param idEnteConvenz id ente convenzionato
     *
    ...
    public boolean checkEsistenzaUtenteEnteAppart(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery("SELECT enteSiam FROM OrgEnteSiam enteSiam "
                + "WHERE enteSiam.idEnteSiam = :idEnteConvenz " + "AND EXISTS "
                + "(SELECT user FROM UsrUser user " + "WHERE user.orgEnteSiam = enteSiam) ");
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
        List<OrgEnteSiam> list = query.getResultList();
        return !list.isEmpty();
    }
    ...
    /**
     * Controlla se l'utente dato in input ha ente convenzionato di appartenenza uguale all'ente
     * passato in ingresso
     *
    ...
    /**
     * Controlla se esiste almeno un utente avente ente convenzionato uguale all'ente passato in
     * ingresso come abilitazione di tipo UN_ENTE
     *
     * @param idEnteConvenz id ente convenzionato
     *
     * @return true se esistono degli utenti
    ...
    public boolean checkEsistenzaEnteAbilUnEnte(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery("SELECT enteSiam FROM OrgEnteSiam enteSiam "
                + "WHERE enteSiam.idEnteSiam = :idEnteConvenz " + "AND EXISTS "
                + "(SELECT dichAbilEnteConvenz FROM UsrDichAbilEnteConvenz dichAbilEnteConvenz "
    ...
    /**
     * Controlla se esiste almeno una richiesta utente avente ente convenzionato uguale all'ente
     * passato in ingresso
     *
     * @param idEnteConvenz id ente convenzionato
     *
    ...
    public boolean checkEsistenzaRichiesteUtente(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery("SELECT enteSiam FROM OrgEnteSiam enteSiam "
                + "WHERE enteSiam.idEnteSiam = :idEnteConvenz " + "AND EXISTS "
                + "(SELECT richGestUser FROM UsrRichGestUser richGestUser "
    ...
    /**
     * Controlla se esiste almeno una associazione struttura - ente convenzionato (uguale all'ente
     * passato in ingresso) in periodo di validità
     *
     * @param idEnteConvenz id ente convenzionato
     *
    ...
    public List<OrgTipoAccordo> retrieveOrgTipoAccordo() {
        Query query = getEntityManager().createQuery(
                "SELECT tipoAccordo FROM OrgTipoAccordo tipoAccordo ORDER BY tipoAccordo.cdTipoAccordo ");
    ...
    public List<OrgTipoAccordo> retrieveOrgTipoAccordoNoClasseEnte() {
        Query query = getEntityManager()
                .createQuery("SELECT tipoAccordo FROM OrgTipoAccordo tipoAccordo "
    ...
    public List<OrgTariffario> retrieveOrgTariffario(BigDecimal idTipoAccordo) {
        Query query = getEntityManager()
                .createQuery("SELECT tariffario FROM OrgTariffario tariffario "
    ...
    public List<OrgServizioErog> retrieveOrgServizioErog(BigDecimal idAccordoEnte) {
        Query query = getEntityManager()
                .createQuery("SELECT servizioErog FROM OrgServizioErog servizioErog "
    ...
    public List<OrgModuloInfoAccordo> retrieveOrgModuloInfoAccordo(BigDecimal idAccordoEnte) {
        Query query = getEntityManager()
                .createQuery("SELECT moduloInfo FROM OrgModuloInfoAccordo moduloInfo "
                        + "WHERE moduloInfo.orgAccordoEnte.idAccordoEnte = :idAccordoEnte "
                        + "ORDER BY moduloInfo.dtRicev ");
        query.setParameter("idAccordoEnte", idAccordoEnte.longValue());
    ...
    public List<OrgModuloInfoAccordo> retrieveOrgModuloInfoAccordoByEnte(BigDecimal idEnteConvenz) {
        Query query = getEntityManager()
                .createQuery("SELECT moduloInfo FROM OrgModuloInfoAccordo moduloInfo "
                        + "WHERE moduloInfo.orgEnteConvenz.idEnteSiam = :idEnteConvenz "
                        + "ORDER BY moduloInfo.dtRicev ");
        query.setParameter("idEnteConvenz", idEnteConvenz.longValue());
        List<OrgModuloInfoAccordo> list = query.getResultList();
        return list;
    ...
    public List<OrgGestioneAccordo> retrieveOrgGestioneAccordo(BigDecimal idAccordoEnte) {
        Query query = getEntityManager()
                .createQuery("SELECT gestioneAccordo FROM OrgGestioneAccordo gestioneAccordo "
                        + "WHERE gestioneAccordo.orgAccordoEnte.idAccordoEnte = :idAccordoEnte "
    ...
    public boolean checkEsistenzaAltriAccordiDtDecDtFineValid(BigDecimal idEnteConvenz,
            Date dtDecAccordo, Date dtFineValidAccordo, BigDecimal idAccordoDaEscludere) {
        String queryStr = "SELECT COUNT(accordoEnte) FROM OrgAccordoEnte accordoEnte "
                ...
                // Se la data di inizio validità o quella di fine validitÃ  accordo, ricadono
                // all'interno di un
    ...
    public boolean isDtDecDtFineValIndefinite(BigDecimal idEnteConvenz) {
        ...
        for (OrgAccordoEnte accordoEnte : accordoEnteList) {
            if (DateUtils.truncate(accordoEnte.getDtDecAccordo(), Calendar.DATE)
                    .equals(DateUtil.MAX_DATE)
                    || DateUtils.truncate(accordoEnte.getDtFineValidAccordo(), Calendar.DATE)
                            .equals(DateUtil.MAX_DATE)) {
                return true;
            }
        }
    ...
    public boolean checkEsistenzaAccordoSuDataRegistrazione(BigDecimal idEnteConvenz,
            Date dtRegAccordo, BigDecimal idAccordoDaEscludere) {
        String queryStr = "SELECT COUNT(accordoEnte) FROM OrgAccordoEnte accordoEnte "
                + "WHERE accordoEnte.orgEnteSiam.idEnteSiam = :idEnteConvenz "
    ...
    public boolean checkEsistenzaAccordiAttivi(BigDecimal idEnteConvenz) {
        String queryStr = "SELECT 1 FROM OrgAccordoEnte accordoEnte "
                + "WHERE accordoEnte.orgEnteSiam.idEnteSiam = :idEnteConvenz "
                + "AND accordoEnte.dtDecAccordo IS NOT NULL "
    ...
    public boolean isDataCessazioneEnteInferioreUgualeDataAccordo(long idEnteSiam,
            Date dtCessazione) {
        Query query = getEntityManager()
                .createQuery("SELECT accordoEnte FROM OrgAccordoEnte accordoEnte "
    ...
    public boolean checkEsistenzaUtenteAbilitatoXEnte(BigDecimal idUserIam,
            BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery(
                "SELECT 1 FROM UsrVAbilEnteConvenz abilEnteConvenz, OrgEnteSiam enteSiam "
    ...
    public boolean checkEsistenzaAmbienteValidoDtDecDtFineValid(BigDecimal idAmbienteEnteConvenz,
        ...
        String queryStr = "SELECT COUNT(ambienteEnteConvenz) FROM OrgAmbienteEnteConvenz ambienteEnteConvenz "
                + "WHERE ambienteEnteConvenz.idAmbienteEnteConvenz = :idAmbienteEnteConvenz "
                + "AND ("
                // Se la data di inizio validità o quella di fine validitÃ  accordo, ricadono in
                // all'interno di un
        ...
        if (idAmbienteDaEscludere != null) {
            queryStr = queryStr
                    + "AND ambienteEnteConvenz.idAmbienteEnteConvenz != :idAmbienteDaEscludere ";
        }
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idAmbienteEnteConvenz", longFrom(idAmbienteEnteConvenz));
        query.setParameter("dtDecAccordo", dtDecAccordo);
    ...
    public List<UsrTipoDatoIam> getUsrTipoDatoIam(String nmApplic, String nmTipoOrganiz,
            BigDecimal idOrganizApplic, String nmClasseTipoDato) {
        Query query = getEntityManager()
                .createQuery("SELECT tipoDatoIam FROM UsrTipoDatoIam tipoDatoIam "
                        + "JOIN tipoDatoIam.usrOrganizIam organizIam "
                        + "JOIN tipoDatoIam.aplClasseTipoDato classeTipoDato "
                        + "JOIN organizIam.aplTipoOrganiz tipoOrganiz "
                        + "JOIN tipoOrganiz.aplApplic applic "
                        + "WHERE applic.nmApplic = :nmApplic "
                        + "AND tipoOrganiz.nmTipoOrganiz = :nmTipoOrganiz "
                        + "AND organizIam.idOrganizApplic = :idOrganizApplic "
                        + "AND classeTipoDato.nmClasseTipoDato = :nmClasseTipoDato "
                        + "AND classeTipoDato.aplApplic = applic "
    ...
    public List<OrgTariffa> retrieveOrgTariffa(BigDecimal idTipoServizio, BigDecimal idTariffario,
        ...
        if (idTipoServizio != null) {
            queryStr.append(whereWord)
                    .append("tariffa.orgTipoServizio.idTipoServizio = :idTipoServizio ");
            whereWord = "AND ";
        }
        if (idClasseEnteConvenz != null) {
            queryStr.append(whereWord).append(
                    "tariffa.orgClasseEnteConvenz.idClasseEnteConvenz = :idClasseEnteConvenz ");
            whereWord = "AND ";
        }
        if (idTariffario != null) {
            queryStr.append(whereWord)
                    .append("tariffa.orgTariffario.idTariffario = :idTariffario ");
            whereWord = "AND ";
        }
    ...
    @Deprecated
    public Date getDtFirstVersTipiUdByTipoServizio(long idTipoServizio,
            List<BigDecimal> idOrganizApplicSelected) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT tipoUnitaDoc.dtFirstVers FROM DecTipoUnitaDoc tipoUnitaDoc "
     ...
     * @param idOrganizApplicSelected id organizzazione selezionata
     *
    ...
    public String getUltimoStatoFatturaEnte(long idFatturaEnte) {
        Query query = getEntityManager().createQuery(
                "SELECT statoFatturaEnte.tiStatoFatturaEnte FROM OrgStatoFatturaEnte statoFatturaEnte "
    ...
    public BigDecimal getImValoreTariffaDaScaglione(long idTariffa) {
        Query query = getEntityManager().createQuery(
                "SELECT scaglioneTariffa.imScaglione FROM OrgScaglioneTariffa scaglioneTariffa "
    ...
    public List<OrgTipoServizio> retrieveOrgTipoServizio(long idClasseEnteConvenz,
            long idTariffario, List<BigDecimal> idTipoServizioEsclusi) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT tipoServizio FROM OrgTipoServizio tipoServizio "
    ...
    public boolean checkEsistenzaAnnualitaPerAccordo(BigDecimal aaAnnoAccordo,
            BigDecimal idAccordoEnte) {
        String queryStr = "SELECT accordoEnte FROM OrgAccordoEnte accordoEnte "
                + "WHERE accordoEnte.idAccordoEnte = :idAccordoEnte "
                + "AND EXISTS (SELECT annualita FROM OrgAaAccordo annualita "
                + "WHERE annualita.orgAccordoEnte = accordoEnte "
                + "AND annualita.aaAnnoAccordo = :aaAnnoAccordo) ";
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idAccordoEnte", longFrom(idAccordoEnte));
    ...
    public boolean checkEsistenzaServiziErogatiPerAccordo(BigDecimal idServizioErogato,
            BigDecimal idAccordoEnte, BigDecimal idTipoServizio, BigDecimal idSistemaVersante) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT accordoEnte FROM OrgAccordoEnte accordoEnte "
                        + "WHERE accordoEnte.idAccordoEnte = :idAccordoEnte "
        ...
        if (idSistemaVersante != null) {
            queryStr.append(
                    "AND servizioErog.aplSistemaVersante.idSistemaVersante = :idSistemaVersante ");
        }
        queryStr.append(")");
        Query query = getEntityManager().createQuery(queryStr.toString());
    ...
    public List<OrgTipoServizio> retrieveOrgTipoServizio() {
        Query query = getEntityManager()
                .createQuery("SELECT tipoServizio FROM OrgTipoServizio tipoServizio ");
        List<OrgTipoServizio> list = query.getResultList();
        return list;
    }
    ...
    public OrgTariffa retrieveOrgTariffa(long idTariffario, String nmTariffa) {
        Query query = getEntityManager().createQuery("SELECT tariffa FROM OrgTariffa tariffa "
                + "WHERE tariffa.orgTariffario.idTariffario = :idTariffario "
                + "AND tariffa.nmTariffa = :nmTariffa ");
        query.setParameter("idTariffario", longFrom(idTariffario));
    ...
    public List<OrgTipoAccordo> retrieveOrgTipoAccordoList(String cdTipoAccordo,
            String dsTipoAccordo, String flPagamento, String isAttivo) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT tipoAccordo FROM OrgTipoAccordo tipoAccordo ");
        String clause = " WHERE ";
        ...
        if (isAttivo != null) {
            if (isAttivo.equals("1")) {
                queryStr.append(clause).append(
                        "(tipoAccordo.dtIstituz <= :dataOdierna AND tipoAccordo.dtSoppres >= :dataOdierna) ");
            } else {
                queryStr.append(clause).append(
                        "(tipoAccordo.dtIstituz > :dataOdierna OR tipoAccordo.dtSoppres < :dataOdierna) ");
            }
            clause = " AND ";
        }
     ...
     *
     * @param idTipoAccordo tipo accordo
     *
     * @return true se esistono accordi
     */
    public boolean checkEsistenzaAccordiPerTipoAccordo(BigDecimal idTipoAccordo) {
        Query query = getEntityManager().createQuery("SELECT 1 FROM OrgTipoAccordo tipoAccordo "
    ...
    public List<OrgTariffario> retrieveOrgTariffario(String isValido, String cdTipoAccordo,
            String nomeTariffario) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT tariffario FROM OrgTariffario tariffario ");
        String clause = " WHERE ";
        Date dataOdierna = new Date();
        if (isValido != null) {
            if (isValido.equals("1")) {
                queryStr.append(clause).append(
                        "tariffario.dtIniVal <= :dataOdierna AND tariffario.dtFineVal >= :dataOdierna ");
            } else {
                queryStr.append(clause).append(
                        "tariffario.dtIniVal > :dataOdierna OR tariffario.dtFineVal < :dataOdierna ");
            }
            clause = " AND ";
        }
        if (StringUtils.isNotBlank(cdTipoAccordo)) {
            queryStr.append(clause)
                    .append("UPPER(tariffario.orgTipoAccordo.cdTipoAccordo) LIKE :cdTipoAccordo ");
            clause = " AND ";
        }
    ...
    public List<Object[]> retrieveOrgTariffaAccordoByTipoServizio(BigDecimal idTipoServizio) {
        Query query = getEntityManager().createQuery(
                "SELECT enteSiam.nmEnteSiam, accordoEnte.dtDecAccordo, accordoEnte.dtFineValidAccordo, "
    ...
    public boolean checkEsistenzaAccordiPerTariffario(BigDecimal idTariffario) {
        Query query = getEntityManager().createQuery("SELECT 1 FROM OrgTariffario tariffario "
     ...
     * @param idTariffarioDaEscludere id tariffario da escludere
     *
    ...
    public List<OrgClasseEnteConvenz> retrieveOrgClasseEnteConvenz(String cdClasseEnteConvenz,
        ...
        if (StringUtils.isNotBlank(cdClasseEnteConvenz)) {
            queryStr.append(clause).append(
                    "UPPER(classeEnteConvenz.cdClasseEnteConvenz) LIKE :cdClasseEnteConvenz ");
            clause = " AND ";
        }
        if (StringUtils.isNotBlank(dsClasseEnteConvenz)) {
            queryStr.append(clause).append(
                    "upper(classeEnteConvenz.dsClasseEnteConvenz) LIKE :dsClasseEnteConvenz ");
            clause = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(cdClasseEnteConvenz)) {
            query.setParameter("cdClasseEnteConvenz",
                    "%" + cdClasseEnteConvenz.toUpperCase() + "%");
        }
        if (StringUtils.isNotBlank(dsClasseEnteConvenz)) {
            query.setParameter("dsClasseEnteConvenz",
                    "%" + dsClasseEnteConvenz.toUpperCase() + "%");
        }
        List<OrgClasseEnteConvenz> list = query.getResultList();
        return list;
    }
    ...
    public boolean checkEsistenzaServiziErogatiPerTariffa(BigDecimal idTariffa) {
        Query query = getEntityManager().createQuery(
                "SELECT tariffa FROM OrgTariffa tariffa " + "WHERE tariffa.idTariffa = :idTariffa "
                        + "AND EXISTS " + "(SELECT servizioErog FROM OrgServizioErog servizioErog "
     ...
     *
     * @param cdTipoServizio code tipo servizio
     *
     * @return l'entity richiesta se esiste, oppure <code>null</code>
     */
    ...
    public List<OrgTipoServizio> retrieveOrgTipoServizioList(String cdTipoServizio,
            String tiClasseTipoServizio, String tipoFatturazione) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT tipoServizio FROM OrgTipoServizio tipoServizio ");
        String clause = " WHERE ";
        if (StringUtils.isNotBlank(cdTipoServizio)) {
            queryStr.append(clause)
                    .append("UPPER(tipoServizio.cdTipoServizio) LIKE :cdTipoServizio ");
            clause = " AND ";
        }
        if (tiClasseTipoServizio != null) {
            queryStr.append(clause)
                    .append("tipoServizio.tiClasseTipoServizio = :tiClasseTipoServizio ");
            clause = " AND ";
        }
     ...
     * @param idTariffario        id tariffario
     * @param idTipoServizio      id tipo servizio
     * @param idClasseEnteConvenz id clsse ente convenzionato
     * @param idTariffa           id tariffa
     *
     * @return l'entity richiesta se esiste, oppure <code>null</code>
     */
    public OrgTariffa getOrgTariffa(BigDecimal idTariffario, BigDecimal idTipoServizio,
            BigDecimal idClasseEnteConvenz, BigDecimal idTariffa) {
        OrgTariffa tariffa = null;
    ...
    public List<OrgVRicFatture> retrieveOrgVRicFattureList(String nmEnteConvenz,
        ...
        if (aaFatturaDa != null && aaFatturaA == null) {
            ...
            queryStr.append(clause).append(
                    "(fatture.aaFattura >= :aaFatturaDa AND fatture.aaFattura <= :aaFatturaA)");
            clause = " AND ";
        }
        ...
        if (pgFatturaEnteDa != null && pgFatturaEnteA == null) {
            ...
            queryStr.append(clause).append(
                    "(fatture.pgFattura>= :pgFatturaEnteDa AND fatture.pgFattura<= :pgFatturaEnteA)");
            clause = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(cdRegistroEmisFattura)) {
            queryStr.append(clause)
                    .append("UPPER(fatture.cdRegistroEmisFattura) LIKE :cdRegistroEmisFattura");
            clause = " AND ";
        }
        ...
        if (dtEmisFatturaDa != null && dtEmisFatturaA == null) {
            ...
            queryStr.append(clause)
                    .append("(fatture.dtEmisFattura BETWEEN :dtEmisFatturaDa AND :dtEmisFatturaA)");
            clause = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(cdRegistroEmisFattura)) {
            query.setParameter("cdRegistroEmisFattura",
                    "%" + cdRegistroEmisFattura.toUpperCase() + "%");
        }
        if (aaEmissFattura != null) {
    ...
    public List<OrgVRicFatture> retrieveOrgVRicFattureList2(String nmEnteConvenz,
            BigDecimal idTipoAccordo, BigDecimal idTipoServizio, BigDecimal aaFatturaDa,
            BigDecimal aaFatturaA, BigDecimal pgFatturaEnteDa, BigDecimal pgFatturaEnteA,
            String cdFattura, String cdRegistroEmisFattura, BigDecimal aaEmissFattura,
            String cdEmisFattura, BigDecimal pgFatturaEmis, Date dtEmisFatturaDa,
    ...
    public List<OrgVRicFatturePerAccordo> retrieveOrgVRicFatturePerAccordo(
            BigDecimal idAccordoEnte) {
        StringBuilder queryStr = new StringBuilder(
    ...
    public List<OrgStatoFatturaEnte> getOrgStatoFatturaEnte(BigDecimal idFatturaEnte,
            String tiStatoFatturaEnte) {
        if (idFatturaEnte != null && tiStatoFatturaEnte != null) {
            Query q = getEntityManager().createQuery(
                    "SELECT statoFatturaEnte FROM OrgStatoFatturaEnte statoFatturaEnte "
                            + "WHERE statoFatturaEnte.orgFatturaEnte.idFatturaEnte = :idFatturaEnte "
     ...
     * @param idFatturaEnte     id fattura/ente
     * @param idServizioErogato id servizio erogato
     * @param aaServizioFattura anno servizio fattura
     *
     * @return la lista di entity se esistono, oppure <code>null</code>
     */
    public OrgServizioFattura getOrgServizioFattura(BigDecimal idFatturaEnte,
            BigDecimal idServizioErogato, BigDecimal aaServizioFattura) {
    ...
    public List<OrgVCreaServErogByAcc> getServiziErogatiSuAccordo(long idAccordoEnte) {
        Query query = getEntityManager().createQuery(
                "SELECT creaServErogByAcc FROM OrgVCreaServErogByAcc creaServErogByAcc "
    ...
    public List<OrgVRicEnteConvenz> retrieveEntiConvenzAbilitatiSoloAmm(BigDecimal idUserIamCor) {
        Query query = getEntityManager()
                .createQuery("SELECT ricEnteConvenz FROM OrgVRicEnteConvenz ricEnteConvenz "
                        + "WHERE ricEnteConvenz.idUserIamCor = :idUserIamCor "
                        + "AND ricEnteConvenz.tiEnteConvenz = 'AMMINISTRATORE' "
                        + "ORDER BY ricEnteConvenz.nmEnteConvenz ");
        query.setParameter("idUserIamCor", idUserIamCor);
        query.setParameter("dataOdierna", new Date());
        return (List<OrgVRicEnteConvenz>) query.getResultList();
     ...
     */
    @Deprecated
    public List<OrgAmbienteEnteConvenz> retrieveAmbientiEntiConvenzAbilitatiSoloAmm(
    ...
    public List<OrgVRicEnteConvenz> retrieveEntiConvenzCollegAbilitatiAmbiente(
        ...
        if (tiEnteConvenz != null && tiEnteConvenz.length > 0) {
            List<TiEnteConvenz> tipiList = Arrays.asList(tiEnteConvenz);
            query.setParameter("tiEnteConvenz",
                    tipiList.stream().map(t -> t.name()).collect(Collectors.toList()));
        }
        return (List<OrgVRicEnteConvenz>) query.getResultList();
    }
    ...
    public List<OrgVRicEnteNonConvenz> retrieveEntiNonConvenzAbilitati(BigDecimal idUserIam,
        ...
        if (tiEnteNonConvenz != null) {
            queryStr.append(whereWord)
                    .append("ricEnteNonConvenz.tiEnteNonConvenz = :tiEnteNonConvenz ");
            whereWord = " AND ";
        }
    ...
    public List<OrgVRicEnteNonConvenz> retrieveEntiNonConvenzAbilitati(BigDecimal idUserIam,
        ...
        if (tiEnteNonConvenz != null) {
            queryStr.append(whereWord)
                    .append("ricEnteNonConvenz.tiEnteNonConvenz IN :tiEnteNonConvenz ");
            whereWord = " AND ";
        }
        queryStr.append("ORDER BY ricEnteNonConvenz.nmEnteSiam");
        Query query = getEntityManager().createQuery(queryStr.toString());
    ...
    public List<OrgVRicEnteConvenz> retrieveEntiConvenzAbilitatiXEnteCapofila(
        ...
        if (idAmbienteEnteConvenz != null) {
            queryStr.append(clause)
                    .append("ricEnteConvenz.idAmbienteEnteConvenz = :idAmbienteEnteConvenz ");
            clause = " AND ";
        }
        queryStr.append(clause).append("ricEnteConvenz.flNonConvenz = '0' "
    ...
    public List<OrgVRicEnteConvenz> retrieveEntiConvenzAbilitatiXEnteCapofila(
        ...
        // MAC#20840
        // queryStr.append(clause)
        // .append("(ricEnteConvenz.dtIniVal <= :dataOdierna AND ricEnteConvenz.dtCessazione >=
        // :dataOdierna) ");
        // end MAC#20840
        clause = " ORDER BY ";
    ...
    public List<UsrVAbilAmbEnteConvenz> retrieveAbilAmbEntiConvenzValidByIdEnteConserv(
    ...
    public List<UsrVAbilAmbEnteXente> retrieveAmbientiEntiXenteAbilitatiValid(
    ...
    public List<UsrVAbilEnteConvenz> retrieveEntiConvenzAbilitatiByUtenteAmbiente(
    ...
    public OrgAmbienteEnteConvenz retrieveOrgAmbienteEnteConvenzByEnteConvenz(
            BigDecimal idEnteConvenz) {
        Query query = getEntityManager()
                .createQuery("SELECT ambienteEnteConvenz FROM OrgEnteSiam enteSiam "
    ...
    public List<UsrVAbilAmbConvenzXente> retrieveAmbientiEntiConvenzAbilitati(BigDecimal idUserIam,
        ...
        if (StringUtils.isNotBlank(nmAmbienteEnteConvenz)) {
            queryStr.append(clause).append(
                    "UPPER(abilAmbConvenzXEnte.nmAmbienteEnteConvenz) LIKE :nmAmbienteEnteConvenz ");
        }

        if (StringUtils.isNotBlank(dsAmbienteEnteConvenz)) {
            queryStr.append(clause).append(
                    "UPPER(abilAmbConvenzXEnte.dsAmbienteEnteConvenz) LIKE :dsAmbienteEnteConvenz ");
        }
        ...
        if (StringUtils.isNotBlank(nmAmbienteEnteConvenz)) {
            query.setParameter("nmAmbienteEnteConvenz",
                    "%" + nmAmbienteEnteConvenz.toUpperCase() + "%");
        }
        if (StringUtils.isNotBlank(dsAmbienteEnteConvenz)) {
            query.setParameter("dsAmbienteEnteConvenz",
                    "%" + dsAmbienteEnteConvenz.toUpperCase() + "%");
        }
     ...
     *
     * @param nmAmbienteEnteConvenz nome ambiente ente
     *
     * @return l'entity richiesta se esiste, oppure <code>null</code>
     */
     ...
     *
     * @param nmColleg nome collegamento ente
     *
     * @return l'entity richiesta se esiste, oppure <code>null</code>
     */
    ...
    public OrgEnteSiam retrieveEnteCapofila(BigDecimal idEnteConvenzCapofila) {
        OrgEnteSiam enteCapofila = getEntityManager().find(OrgEnteSiam.class,
                idEnteConvenzCapofila.longValue());
        return enteCapofila;
    }
     ...
     */
    public List<OrgVRicEnteConvenz> retrieveOrgVRicEnteConvenzByAmbiente(
    ...
    /*
     * NOTA: su richiesta, respinta, di aggiungere il campo nmServizioErogato nella vista, si Ã¨
     * proceduto al join per recuperare lo stesso
     */
    ...
    public List<Object[]> retrieveOrgVLisServFatturaListByIdServizioErog(
            BigDecimal idServizioErogato) {
    ...
    public List<Object[]> retrieveFattureRiemesseList(BigDecimal idFatturaEnte) {
        String queryStr = "SELECT DISTINCT fatturaEnte.cdRegistroEmisFattura, fatturaEnte.aaEmissFattura, fatturaEnte.cdEmisFattura, "
                ...
                + "FROM OrgFatturaEnte fatturaEnte "
                + "LEFT JOIN fatturaEnte.orgPagamFatturaEntes pagamFatturaEnte "
    ...
    /**
     * Controlla che nel periodo compreso tra data di inizio e di fine validitÃ  non sia giÃ 
     * presente un'altra anagrafica per l'ente convenzionato, escludendo l'anagrafica corrente
     *
     * @param idEnteConvenz               id ente/convenzionato
     * @param dtIniVal                    data inizio validita
     * @param dtFineVal                   data fine validita
     * @param idStoEnteConvenzDaEscludere id stato ente convenzionato da escludere
     *
    ...
    public boolean existOtherAnagrafichePerIntervallo(BigDecimal idEnteConvenz, Date dtIniVal,
        ...
        if (idStoEnteConvenzDaEscludere != null) {
            queryStr = queryStr
                    + "AND stoEnteConvenz.idStoEnteConvenz != :idStoEnteConvenzDaEscludere ";
        }
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
        query.setParameter("dtIniVal", dtIniVal);
        query.setParameter("dtFineVal", dtFineVal);
        if (idStoEnteConvenzDaEscludere != null) {
            query.setParameter("idStoEnteConvenzDaEscludere",
                    longFrom(idStoEnteConvenzDaEscludere));
        }
        List<OrgStoEnteConvenz> list = query.getResultList();
        return !list.isEmpty();
    }
    ...
    public OrgCdIva getOrgCdIvaByCdIva(String cdIva) throws ParerUserError {
        Query query = getEntityManager().createQuery(
                "SELECT orgCdIva FROM OrgCdIva orgCdIva WHERE orgCdIva.cdIva = :cdIva");
    ...
    public boolean checkModificheIntervenuteFattura(BigDecimal idFatturaEnte) {
        Query query = getEntityManager().createQuery(
                "SELECT COUNT(modifFatturaEnte) FROM OrgModifFatturaEnte modifFatturaEnte "
    ...
    public List<OrgVCreaFatturaByAnno> getOrgVCreaFatturaByAnno(BigDecimal idEnteConvenz,
            BigDecimal aaFattura, BigDecimal aaServizioFattura) {
        StringBuilder queryStr = new StringBuilder(
    ...
    /*
     * public List<OrgVCreaServFattByFatt> getOrgVCreaServFattByFatt(BigDecimal idFatturaEnte) {
     * Query query = getEntityManager()
     * .createQuery("SELECT creaServFattByFatt FROM OrgVCreaServFattByFatt creaServFattByFatt " +
     * "WHERE creaServFattByFatt.id.idFatturaEnte = :idFatturaEnte ");
     * query.setParameter("idFatturaEnte", idFatturaEnte); return (List<OrgVCreaServFattByFatt>)
     * query.getResultList(); }
     */
    /**
     * Ritorna l'elenco dei servizi da fatturare per la fattura in ingresso e l'anno specificato,
     * controllando che essi non siano già presenti in fatture precedenti in stato diverso da
     * STORNATA
     *
     * @param idFatturaEnte   id fattura/ente
     * @param idAccordoEnte   id accordo ente
     * @param annoFattServizi anno fattura/servizi
     *
    ...
    public List<OrgVCreaServFattAnnuale> getOrgVCreaServFattAnnualeCustom(BigDecimal idFatturaEnte,
        ...
        Query query = getEntityManager().createQuery(
                "SELECT creaServFattAnnuale FROM OrgVCreaServFattAnnuale creaServFattAnnuale "
     ...
     * STORNATA
     *
     * @param idFatturaEnte   id fatture/ente
     * @param idAccordoEnte   id accordo
     * @param annoFattServizi anno fattura servizi
     *
     * @return lista elementi di tipo {@link OrgVCreaServFattUnatantum}
     */
    public List<OrgVCreaServFattUnatantum> getOrgVCreaServFattUnatantumCustom(
            BigDecimal idFatturaEnte, BigDecimal idAccordoEnte, BigDecimal annoFattServizi) {
        Query query = getEntityManager().createQuery(
                "SELECT creaServFattUnatantum FROM OrgVCreaServFattUnatantum creaServFattUnatantum "
    ...
    public List<OrgVCreaServFattUnaPrec> getOrgVCreaServFattUnaPrecCustom(BigDecimal idFatturaEnte,
            BigDecimal idAccordoEnte, BigDecimal annoFattServizi) {
        Query query = getEntityManager().createQuery(
                "SELECT creaServFattUnaPrec FROM OrgVCreaServFattUnaPrec creaServFattUnaPrec "
    ...
    public OrgVCreaFatturaByFatt getOrgVCreaFatturaByFatt(long idFatturaStornataDaRiemettere,
            BigDecimal aaFattura) {
        ...
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idFatturaStornataDaRiemettere",
                bigDecimalFrom(idFatturaStornataDaRiemettere));
        query.setParameter("aaFattura", aaFattura);
        List<OrgVCreaFatturaByFatt> creaFattureByFattList = (List<OrgVCreaFatturaByFatt>) query
                .getResultList();
    ...
    public List<Long> getIdFattureStornateDaRiemettereList(BigDecimal idEnteConvenz) {
        String queryStr = "SELECT fatturaEnte.idFatturaEnte FROM OrgFatturaEnte fatturaEnte, OrgStatoFatturaEnte statoFatturaEnte "
                ...
                + "AND fatturaEnte.orgEnteSiam.idEnteSiam = :idEnteConvenz "
                + "AND fatturaEnte.flDaRiemis = '1' ";
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
    ...
    public OrgSollecitoFatturaEnte getOrgSollecitoFatturaEnte(BigDecimal idFatturaEnte,
            String cdRegistroSollecito, BigDecimal aaVarSollecito, String cdKeyVarSollecito) {
        String queryStr = "SELECT sollecitoFatturaEnte FROM OrgSollecitoFatturaEnte sollecitoFatturaEnte "
                + "WHERE sollecitoFatturaEnte.orgFatturaEnte.idFatturaEnte = :idFatturaEnte "
        ...
        List<OrgSollecitoFatturaEnte> sollecitiList = (List<OrgSollecitoFatturaEnte>) query
                .getResultList();
    ...
    public List<OrgFatturaEnte> getOrgFatturaEnteByStatoList(List<String> tiStatoFatturaEnte) {
        Query q = getEntityManager().createQuery(
                "SELECT fatturaEnte FROM OrgStatoFatturaEnte statoFatturaEnte, OrgFatturaEnte fatturaEnte "
     ...
     */
    public List<OrgFatturaEnte> getFattureEnteConvenzionato(BigDecimal idEnteConvenz,
            String tiStatoFatturaEnte) {
        Query query = getEntityManager().createQuery(
                "SELECT fatturaEnte FROM OrgStatoFatturaEnte statoFatturaEnte, OrgFatturaEnte fatturaEnte "
                        + "JOIN fatturaEnte.orgEnteSiam enteSiam "
                        + "WHERE enteSiam.idEnteSiam = :idEnteConvenz "
                        + "AND statoFatturaEnte.tiStatoFatturaEnte = :tiStatoFatturaEnte "
    ...
    public List<OrgVEnteConvByDelabilorg> getEntiConvByAbilEliminate(
            Set<BigDecimal> dichOrganizDeleteList) {
        Query query = getEntityManager().createQuery(
                "SELECT enteConvByDelabilorg FROM OrgVEnteConvByDelabilorg enteConvByDelabilorg "
    ...
    public boolean existsUtenteArchivistaPerEnteSiam(BigDecimal idEnteSiam, BigDecimal idUserIam,
            String flReferente, BigDecimal idUserIamExcluded) {
    ...
    public boolean existsReferenteEntePerEnteSiam(BigDecimal idEnteSiam, BigDecimal idUserIam,
            String qualificaUser) {
    ...
    public boolean existsEnteCollegatoPerCollegamento(BigDecimal idCollegEntiConvenz,
            BigDecimal idEnteConvenz) {
    ...
    public boolean existsUDInSacer(BigDecimal idOrganizApplic, String registro, BigDecimal anno,
        ...
        String queryStr = "SELECT unitaDoc FROM AroUnitaDoc unitaDoc "
                + "WHERE unitaDoc.idOrgStrut = :idOrganizApplic "
                + "AND unitaDoc.cdRegistroKeyUnitaDoc = :registro "
                + "AND unitaDoc.aaKeyUnitaDoc = :anno " + "AND unitaDoc.cdKeyUnitaDoc = :numero ";
        Query query = getEntityManager().createQuery(queryStr);
    ...
    public List<OrgAppartCollegEnti> getOrgAppartCollegEntiList(BigDecimal idCollegEntiConvenz) {
        String queryStr = "SELECT appartCollegEnti FROM OrgAppartCollegEnti appartCollegEnti "
                + " JOIN FETCH appartCollegEnti.orgCollegEntiConvenz "
                + " JOIN FETCH appartCollegEnti.orgEnteSiam "
    ...
    public boolean existsDisciplinare(BigDecimal idAccordoEnte, BigDecimal idOrganizIam,
            Date dtDiscipStrut) {
        String queryStr = "SELECT discipStrut FROM OrgDiscipStrut discipStrut "
                + "WHERE discipStrut.orgAccordoEnte.idAccordoEnte = :idAccordoEnte "
    ...
    public boolean existsDisciplinareByEnte(BigDecimal idEnteConvenz, BigDecimal idOrganizIam,
            Date dtDiscipStrut) {
        String queryStr = "SELECT discipStrut FROM OrgDiscipStrut discipStrut "
                + "WHERE discipStrut.orgEnteConvenz.idEnteSiam = :idEnteConvenz "
                + "AND discipStrut.usrOrganizIam.idOrganizIam = :idOrganizIam "
    ...
    public OrgDiscipStrut getDisciplinareByEnteOrganizData(BigDecimal idEnteConvenz,
            BigDecimal idOrganizIam, Date dtDiscipStrut) {
        String queryStr = "SELECT discipStrut FROM OrgDiscipStrut discipStrut "
                + "WHERE discipStrut.orgEnteConvenz.idEnteSiam = :idEnteConvenz "
                + "AND discipStrut.usrOrganizIam.idOrganizIam = :idOrganizIam "
                + "AND discipStrut.dtDiscipStrut = :dtDiscipStrut ";
    ...
    public int getNumMaxGestAccordoEnte(BigDecimal idAccordoEnte) {
        ...
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idAccordoEnte", idAccordoEnte.longValue());
        return query.getSingleResult() != null ? ((BigDecimal) query.getSingleResult()).intValue()
                : 0;
    }
     ...
     * @param flAppartApplic   flag appartenenza applicativo 1/0 (true/false)
     * @param flApparteEnte    flag appartenenza ente 1/0 (true/false)
     * @param flAppartAmbiente flag appartenenza ambiente 1/0 (true/false)
     *
    ...
    public List<IamParamApplic> getIamParamApplicList(String tiParamApplic, String tiGestioneParam,
        ...
        StringBuilder queryStr = new StringBuilder(
                "SELECT paramApplic FROM IamParamApplic paramApplic ");
        String whereWord = " WHERE ";
     ...
     * @param flApparteEnte     flag appartenenza ente 1/0 (true/false)
     * @param flAppartAmbiente  flag appartenenza ambiente 1/0 (true/false)
     * @param filterValid       flag per mostrare o meno i parametri cessati
     * @param cdVersioneAppIni  versione iniziale applicativo
     * @param cdVersioneAppFine versione finale applicativo
     *
     * @return lista elementi di tipo {@link IamParamApplic}
     */
    public List<IamParamApplic> getIamParamApplicList(String tiParamApplic, String tiGestioneParam,
            String flAppartApplic, String flAppartAmbiente, String flApparteEnte,
            boolean filterValid, String cdVersioneAppIni, String cdVersioneAppFine) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT paramApplic FROM IamParamApplic paramApplic ");
        String whereWord = " WHERE ";
        if (tiParamApplic != null) {
    ...
    public List<IamParamApplic> getIamParamApplicListAmbiente(String tiGestioneParam,
            boolean filterValid) {
    ...
    public List<IamParamApplic> getIamParamApplicListEnte(String tiGestioneParam,
            boolean filterValid) {
    ...
    public boolean existsIamValoreParamApplic(long idParamApplic, String tiAppart) {
        Query q = getEntityManager()
                .createQuery("SELECT 1 FROM IamValoreParamApplic valoreParamApplic "
    ...
    public IamValoreParamApplic getIamValoreParamApplic(long idParamApplic, String tiAppart) {
        Query q = getEntityManager()
                .createQuery("SELECT valoreParamApplic FROM IamValoreParamApplic valoreParamApplic "
                        + "WHERE valoreParamApplic.iamParamApplic.idParamApplic = :idParamApplic "
                        + "AND valoreParamApplic.tiAppart = :tiAppart ");
        q.setParameter("idParamApplic", longFrom(idParamApplic));
        q.setParameter("tiAppart", tiAppart);
    ...
    public boolean existsIamParamApplic(String nmParamApplic, BigDecimal idParamApplic) {
        Query q = getEntityManager()
                .createQuery("SELECT paramApplic FROM IamParamApplic paramApplic "
    ...
    public List<IamParamApplic> getIamParamApplicListEnte() {
        Query q = getEntityManager()
                .createQuery("SELECT paramApplic FROM IamParamApplic paramApplic "
                        + "WHERE paramApplic.flApparteEnte = '1' "
    ...
    public List<Object[]> getAmbientiAbilitatiUnAmbienteList(long idUserIamCor, String tipoEnte,
            BigDecimal idEnte) {
        String nomeVista = "";
        String andClause = "";
        ...
        String queryStr = String.format(
                "SELECT abil.id.idAmbienteEnteConvenz, abil.nmAmbienteEnteConvenz, abil.dsCausaleDich FROM %1$s abil "
                        + "WHERE abil.id.idUserIamCor = :idUserIamCor %2$s "
                        + "ORDER BY abil.nmAmbienteEnteConvenz",
                nomeVista, andClause);
    ...
    public List<Object[]> getEntiAbilitatiUnEnteList(long idUserIamCor, String tipoEnteConvenz,
        ...
        String queryStr = String.format(
                "SELECT abil.id.idEnteConvenz, abil.nmEnteConvenz, abil.dsCausaleDich %3$s FROM %1$s abil "
                        + "WHERE abil.id.idUserIamCor = :idUserIamCor "
                        + "AND abil.idAmbienteEnteConvenz = :idAmbienteEnteConvenz %2$s "
                        + "ORDER BY abil.nmEnteConvenz",
                nomeVista, andClause, altriEnti);
    ...
    public List<Object[]> getAmbientiEntiAbilitatiUnEnteList(long idUserIamCor, String tipoEnte,
            BigDecimal idEnte) {
        String nomeVista = "";
        String andClause = "";
        BigDecimal idEntePerQuery = null;
        ...
        String queryStr = String
                .format("SELECT DISTINCT abil.idAmbienteEnteConvenz, abil.nmAmbienteEnteConvenz "
                        + "FROM %1$s abil " + "WHERE abil.id.idUserIamCor = :idUserIamCor %2$s "
                        + "ORDER BY abil.nmAmbienteEnteConvenz", nomeVista, andClause);
    ...
    public List<Object[]> getAmbietiDaUsrVLisEntiSiamCreaUserList(BigDecimal idRichGestUser,
            long idUserIamCor) {
        Query q = getEntityManager().createQuery(
    ...
    public List<Object[]> getAmbietiDaUsrVLisEntiSiamPerAzioList(BigDecimal idRichGestUser,
            long idUserIamCor) {
        Query q = getEntityManager().createQuery(
    ...
    public List<Object[]> getEntiDaUsrVLisEntiSiamCreaUserList(BigDecimal idRichGestUser,
            long idUserIamCor, BigDecimal idAmbienteEnteConvenz) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT entiSiamCreaUser.id.idEnteSiam, entiSiamCreaUser.nmEnteSiam "
                        + "FROM UsrVLisEntiSiamCreaUser entiSiamCreaUser "
                        + "WHERE entiSiamCreaUser.idRichGestUser = :idRichGestUser "
                        + "AND entiSiamCreaUser.id.idUserIamCor = :idUserIamCor ");
        if (idAmbienteEnteConvenz != null) {
    ...
    public List<Object[]> getEntiDaUsrVLisEntiSiamPerAzioList(BigDecimal idRichGestUser,
            long idUserIamCor, BigDecimal idAmbienteEnteConvenz) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT entiSiamPerAzio.id.idEnteSiam, entiSiamPerAzio.nmEnteSiam "
                        + "FROM UsrVLisEntiSiamPerAzio entiSiamPerAzio "
    ...
    public List<Object[]> getEntiDaUsrVLisEntiSiamAppEnteList(long idUserIamCor,
            BigDecimal idAmbienteEnteConvenz) {
        StringBuilder queryStr = new StringBuilder(
                "SELECT entiSiamAppEnte.idEnteSiam, entiSiamAppEnte.nmEnteSiam "
                        + "FROM UsrVLisEntiSiamAppEnte entiSiamAppEnte "
                        + "WHERE entiSiamAppEnte.idUserIamCor = :idUserIamCor ");
        if (idAmbienteEnteConvenz != null) {
    ...
    public List<Object[]> getAmbientiDaUsrVLisEntiModifAppEnteList(BigDecimal idRichGestUser,
    ...
    public List<Object[]> getEntiDaUsrVLisEntiModifAppEnteList(BigDecimal idRichGestUser,
    ...
    public List<OrgAppartCollegEnti> retrieveOrgAppartCollegEntiByIdEnteConvenz(
            BigDecimal idEnteConvenz) {
        String queryStr = "SELECT appartCollegEnti FROM OrgAppartCollegEnti appartCollegEnti "
                + "WHERE appartCollegEnti.orgEnteSiam.idEnteSiam = :idEnteConvenz ";
        Query query = getEntityManager().createQuery(queryStr);
    ...
    public Long getIdTipoUnitaDoc(BigDecimal idStrut, String nmTipoUnitaDoc) {
        String queryStr = "SELECT tipoUnitaDoc FROM DecTipoUnitaDoc tipoUnitaDoc "
                + "JOIN tipoUnitaDoc.orgStrut strut "
                + "WHERE tipoUnitaDoc.nmTipoUnitaDoc = :nmTipoUnitaDoc "
                + "AND strut.idStrut = :idStrut ";
        Query query = getEntityManager().createQuery(queryStr);
    ...
    public String getTiStatoAccordoById(BigDecimal idAccordoEnte) {
        Query query = getEntityManager()
                .createQuery("SELECT DISTINCT visStatoAccordo.tiStatoAccordo "
                        + "FROM OrgVVisStatoAccordo visStatoAccordo "
                        + "WHERE visStatoAccordo.idAccordoEnte = :idAccordoEnte");
        query.setParameter("idAccordoEnte", idAccordoEnte);
        final List resultList = query.getResultList();
        if (resultList.isEmpty()) {
            throw new NoResultException(
                    "Nessun OrgVVisStatoAccordo trovato per idAccordoEnte" + idAccordoEnte);
        }
        String tiStatoAccordo = (String) resultList.get(0);
        return tiStatoAccordo;
    }

    public List<Object[]> getTipiServizioAssociatiTariffarioPerAccordoDaCreare(
        ...
        Query query = getEntityManager()
                .createQuery("SELECT tipoServizio.idTipoServizio, tipoServizio.cdTipoServizio "
                        ...
                        + "JOIN tariffa.orgTipoServizio tipoServizio "
                        + "WHERE tariffario.idTariffario = :idTariffario "
                        + "AND tipoServizio.flTariffaAccordo = '1' "
                        + "ORDER BY tipoServizio.cdTipoServizio ");
        query.setParameter("idTariffario", longFrom(idTariffario));
        return query.getResultList();
    }

    public List<Object[]> getTipiServizioAssociatiTariffarioPerAnnualitaDaCreare(
            BigDecimal idTariffario) {
        Query query = getEntityManager()
                .createQuery("SELECT tipoServizio.idTipoServizio, tipoServizio.cdTipoServizio "
                        + "FROM OrgTariffa tariffa " + "JOIN tariffa.orgTariffario tariffario "
    ...
    public List<Object[]> getTipiServizioDelTariffarioDelTipoAccordoGiaCreato(
            BigDecimal idTariffario, BigDecimal idAccordoEnte) {
        Query query = getEntityManager().createQuery(
                "SELECT tipoServizio.idTipoServizio, tipoServizio.cdTipoServizio, 0, 0 "
                        + "FROM OrgTariffa tariffa " + "JOIN tariffa.orgTariffario tariffario "
                        + "JOIN tariffa.orgTipoServizio tipoServizio "
                        + "WHERE tariffario.idTariffario = :idTariffario "
                        + "AND tipoServizio.flTariffaAccordo = '1' "
    ...
    // query.setParameter("idAccordoEnte", idAccordoEnte);
    public List<Object[]> getTipiServizioDelTariffarioDelTipoAccordoAnnualitaGiaCreato(
            BigDecimal idTariffario, BigDecimal idAaAccordo) {
        Query query = getEntityManager().createQuery(
                "SELECT tipoServizio.idTipoServizio, tipoServizio.cdTipoServizio, 0, 0 "
                        + "FROM OrgTariffa tariffa " + "JOIN tariffa.orgTariffario tariffario "
                        + "JOIN tariffa.orgTipoServizio tipoServizio "
                        + "WHERE tariffario.idTariffario = :idTariffario "
                        + "AND tipoServizio.flTariffaAnnualita = '1' "
                        + "ORDER BY tipoServizio.cdTipoServizio ");
        query.setParameter("idTariffario", longFrom(idTariffario));
        List<Object[]> tipiServizio = query.getResultList();
        ...
        for (Object[] tipoServizio : tipiServizio) {
            // conversione necessaria perché quando nelle query si imposta una costante numerica di
            // default è Integer
    ...
    private BigDecimal convertToBigDecimal(Object object) {
        Asserts.check(object instanceof Number,
                "La conversione a BigDecimal è possibile solo per dei Number");
    ...
    private Long convertToLong(Object object) {
        Asserts.check(object instanceof Number,
                "La conversione a Long è possibile solo per dei Number");
    ...
    public List<Object[]> getTipiServizioDelTariffarioAnnualitaDelTipoAccordo(
            BigDecimal idTipoAccordo, BigDecimal idAaAccordo) {
        Query query = getEntityManager()
                .createQuery("SELECT tipoServizio.idTipoServizio, tipoServizio.cdTipoServizio, "
    ...
    public OrgTariffaAccordo getOrgTariffaAccordo(BigDecimal idAccordoEnte,
            BigDecimal idTipoServizio) {
        Query query = getEntityManager()
                .createQuery("SELECT tariffaAccordo FROM OrgTariffaAccordo tariffaAccordo "
    ...
    public OrgTariffaAaAccordo getOrgTariffaAaAccordo(BigDecimal idAaAccordo,
            BigDecimal idTipoServizio) {
        Query query = getEntityManager()
    ...
    public List<OrgEnteArkRif> getOrgEnteArkRifList(BigDecimal idEnteConvenz) {
        Query query = getEntityManager()
                .createQuery("SELECT archivisti FROM OrgEnteArkRif archivisti "
    ...
    public Date getMinDateAnagrafica(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery(
                "SELECT MIN(stoEnteConvenz.dtIniVal) FROM OrgStoEnteConvenz stoEnteConvenz "
                        + "WHERE stoEnteConvenz.orgEnteSiam.idEnteSiam = :idEnteConvenz ");
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
    ...
    public Date getMaxDateAnagrafica(BigDecimal idEnteConvenz) {
        Query query = getEntityManager().createQuery(
                "SELECT MAX(stoEnteConvenz.dtFineVal) FROM OrgStoEnteConvenz stoEnteConvenz "
                        + "WHERE stoEnteConvenz.orgEnteSiam.idEnteSiam = :idEnteConvenz ");
        query.setParameter("idEnteConvenz", longFrom(idEnteConvenz));
        return (Date) query.getSingleResult();
    }

    public OrgStoEnteConvenz getOrgStoEnteConvenz(BigDecimal idEnteConvenz,
            BigDecimal idStoEnteConvenzToExclude) {
    ...
    public OrgVVisFattura getPrimoOrgVVisFatturaEnte(BigDecimal idFatturaEnte) {
        if (idFatturaEnte == null) {
            throw new IllegalStateException(
                    "Impossibile trovare un  OrgVVisFattura con idFatturaEnte null");
        }
        Query query = getEntityManager()
                .createQuery("SELECT orgVVisFattura FROM OrgVVisFattura orgVVisFattura "
                        + "WHERE orgVVisFattura.id.idFatturaEnte = :idFatturaEnte "
                        + " ORDER BY orgVVisFattura.dtCreazione");
        query.setParameter("idFatturaEnte", idFatturaEnte);
        List<OrgVVisFattura> fatturaList = query.getResultList();

        if (fatturaList.isEmpty()) {
            throw new IllegalStateException(
                    "Non ci sono record in OrgVVisFattura per idFatturaEnte "
                            + idFatturaEnte.toString());
        }
        return fatturaList.get(0);
    }

    public boolean isStoricoPresente(long idEnteSiam, long idAmbienteEnteConvenzExcluded,
    ...
    public boolean checkIntervalloSuStorico(BigDecimal idEnteConvenz, Date dtIniVal,
            Date dtFinVal) {
        Query query = getEntityManager().createQuery(
                "SELECT storicoEnteAmbiente FROM OrgStoEnteAmbienteConvenz storicoEnteAmbiente "
        ...
        List<OrgStoEnteAmbienteConvenz> lista = (List<OrgStoEnteAmbienteConvenz>) query
                .getResultList();
    ...
    public List<OrgVRicAccordoEnte> retrieveOrgVRicAccordoEnteList(BigDecimal idUserIamCor,
            ...
            String flEsistonoSae, Date saeDa, Date saeA, String flEsistonoSue, Date sueDa,
            Date sueA, String flFasciaManuale, String tiStatoAccordo) {
        StringBuilder queryStr = new StringBuilder(
        ...
        if (StringUtils.isNotBlank(cdRegistroRepertorio)) {
            queryStr.append(clause)
                    .append("UPPER(ente.cdRegistroRepertorio) LIKE :cdRegistroRepertorio");
            clause = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(flEsisteNotaFatturazione)) {
            queryStr.append(clause)
                    .append("ente.flEsisteNotaFatturazione = :flEsisteNotaFatturazione");
            clause = " AND ";
        }
        ...
        if (StringUtils.isNotBlank(cdRegistroRepertorio)) {
            query.setParameter("cdRegistroRepertorio",
                    "%" + cdRegistroRepertorio.toUpperCase() + "%");
        }
        if (aaRepertorio != null) {
    ...
    public List<Object[]> getAnnualitaSenzaAtto() {
        String queryNativeSQL = "SELECT ENTE.NM_ENTE_SIAM, AA_ACC.AA_ANNO_ACCORDO, ACC.CD_REGISTRO_REPERTORIO||'/'||ACC.AA_REPERTORIO||'/'||ACC.CD_KEY_REPERTORIO RPI, TO_CHAR(ACC.DT_REG_ACCORDO,'DD/MM/YYYY'), TIPO_ACC.CD_TIPO_ACCORDO "
                ...
                + "JOIN SACER_IAM.ORG_TIPO_ACCORDO TIPO_ACC "
                + "ON (TIPO_ACC.ID_TIPO_ACCORDO = ACC.ID_TIPO_ACCORDO) "
                + "JOIN SACER_IAM.ORG_AA_ACCORDO AA_ACC "
                + "ON (AA_ACC.ID_ACCORDO_ENTE = ACC.ID_ACCORDO_ENTE) "
    ...
    public List<Object[]> getReportFattureCalcolate() {
        String queryNativeSQL = "select  " + " ente.nm_ente_siam, " + "ente.CD_FISC, "
                ...
                + "serv_fatt.aa_servizio_fattura, " + "aa_acc.DS_ATTO_AA_ACCORDO, "
                + "ente.cd_UFE, " + "aa_acc.cd_cig_aa_accordo, "
                + "round(serv_fatt.im_servizio_fattura, 2), " + "case "
                + "when iva.cd_iva in ('PB', 'HB') "
                + "then round(serv_fatt.im_servizio_fattura * 1.22, 0) "
                + "else round(serv_fatt.im_servizio_fattura, 0) " + "end im_totale, "
                + "iva.cd_iva, " + "case "
                + "when ente.TI_MOD_PAGAM = 'conto tesoreria unica' then ente.TI_MOD_PAGAM "
                + "    else null " + "  end conto_tesoreria_unica, " + " case "
                + "    when ente.TI_MOD_PAGAM = 'conto IBAN' then ente.TI_MOD_PAGAM "
                + "    else null " + "  end conto_IBAN  " + "from ORG_ENTE_SIAM ente "
                + "join org_accordo_ente acc " + "on (acc.id_ente_convenz = ente.id_ente_siam) "
                + "left join org_classe_ente_convenz classe "
                + "on (classe.id_classe_ente_convenz = acc.id_classe_ente_convenz) "
                + "join org_fattura_ente fatt " + "on (fatt.id_ente_convenz = ente.id_ente_siam) "
                ...
                + "on (serv.id_servizio_erogato = serv_fatt.id_servizio_erogato) "
                + "left join apl_sistema_versante sis_vers "
                + "on (sis_vers.id_sistema_versante  = serv.id_sistema_versante) "
                + "join org_tipo_servizio ti_serv "
                + " on (ti_serv.id_tipo_servizio = serv.id_tipo_servizio) "
                + "left join org_aa_accordo aa_acc "
    ...
    public List<Object[]> getReportFattureCalcolateDaRicerca(String nmEnteConvenz,
        ...
        StringBuilder queryStr = new StringBuilder("select  " + " ente.nm_ente_siam, "
                + "ente.CD_FISC, "
                + "serv.nm_servizio_erogato||' - '||serv_fatt.nm_servizio_fattura AS nm_servizio_erogato_completo, "
                + "serv_fatt.aa_servizio_fattura, " + "aa_acc.DS_ATTO_AA_ACCORDO, "
                + "ente.cd_UFE, " + "aa_acc.cd_cig_aa_accordo, "
        ...
        if (aaFatturaDa != null && aaFatturaA == null) {
            ...
            queryStr.append(clause)
                    .append("(fatt.aa_Fattura >= :aaFatturaDa AND fatt.aa_Fattura <= :aaFatturaA)");
            clause = " AND ";
        }
        ...
        if (pgFatturaEnteDa != null && pgFatturaEnteA == null) {
            ...
            queryStr.append(clause).append(
                    "(fatt.pg_Fattura>= :pgFatturaEnteDa AND fatt.pg_Fattura<= :pgFatturaEnteA)");
            clause = " AND ";
        }
        if (StringUtils.isNotBlank(cdFattura)) {
        ...
        if (StringUtils.isNotBlank(cdRegistroEmisFattura)) {
            queryStr.append(clause)
                    .append("UPPER(fatt.cd_Registro_Emis_Fattura) LIKE :cdRegistroEmisFattura");
            clause = " AND ";
        }
        if (aaEmissFattura != null) {
        ...
        if (dtEmisFatturaDa != null && dtEmisFatturaA == null) {
            ...
            queryStr.append(clause)
                    .append("(fatt.dt_Emis_Fattura BETWEEN :dtEmisFatturaDa AND :dtEmisFatturaA)");
            clause = " AND ";
        }
    ...
    public void writeLogEventoByScript() {
        String queryStr = "insert into sacer_log.LOG_EVENTO_BY_SCRIPT " + "( id_evento_by_script, "
                ...
                + "  id_azione_comp_sw, " + "  ti_ruolo_oggetto_evento, "
                + "  ti_ruolo_agente_evento, " + "  id_applic, " + "  ds_motivo_script) "
                + "select "
                + "to_number(1000 || to_char (sacer_log.slog_evento_by_script.nextval)), "
                + "config.id_tipo_oggetto, " + "tmp.id_oggetto id_oggetto, " + "sysdate, "
                + "config.id_agente, " + "config.id_azione_comp_sw, " + "'outcome', "
                + "'executing program', " + "config.id_applic, " + "'Inserimento asincrono' "
                + "from tmp_nuova_richiesta tmp, " + "   (select " + "     ti_ogg.id_tipo_oggetto, "
                + "     comp_sw.id_agente, " + "     azio_sw.id_azione_comp_sw, "
                + "     apl.id_applic " + "    from sacer_iam.apl_applic apl "
                + "    join sacer_iam.apl_comp_sw comp_sw "
                + "     on (comp_sw.id_applic = apl.id_applic) "
                + "    join sacer_iam.apl_azione_comp_sw azio_sw "
                + "     on (azio_sw.id_comp_sw = comp_sw.id_comp_sw) "
                + "    join sacer_iam.apl_tipo_oggetto ti_ogg "
    ...
    public Object[] getDatiLogByScript() {
        String queryStr = "select " + "     ti_ogg.id_tipo_oggetto, " + "     comp_sw.id_agente, "
                + "     azio_sw.id_azione_comp_sw, " + "     apl.id_applic "
    ...
    public List<Object[]> getOrgClusterAccordoList() {
        Query query = getEntityManager().createQuery(
                "SELECT clusterAccordo.idClusterAccordo, clusterAccordo.cdCluster || ' - ' || clusterAccordo.orgFasciaStorageAccordo.tiFascia as ds_cluster_accordo "
                        + "FROM OrgClusterAccordo clusterAccordo "
                        + "ORDER BY clusterAccordo.idClusterAccordo ");
        return query.getResultList();
    }

    public List<Object[]> getOrgFasciaStorageAccordoList() {
        Query query = getEntityManager()
                .createQuery("SELECT fasciaStorageAccordo.idFasciaStorageAccordo, "
    ...
    public Object[] getFasciaDaOccupazione(BigDecimal dimBytesMediaAnno) {
        Query query = getEntityManager().createQuery(
                "SELECT fasciaStorageAccordo.idFasciaStorageAccordo, fasciaStorageAccordo.tiFascia, "//
        ...
        if (resultList != null && !resultList.isEmpty()) {
            ...
            fascia[0] = result[0];
            fascia[1] = (String) result[1] + " - da " + fasciaDaFormattata + " a "
                    + fasciaAFormattata;
        }
        return fascia;
    }

    public OrgVOccupStorageAccordo getOrgVOccupStorageAccordo(BigDecimal idAccordoEnte,
            List<String> cdTipoAccordo) {
        Query query = getEntityManager().createQuery(
    ...
    public Date getDataUltimoVersamentoAccordo(BigDecimal idAccordoEnte) {
        Query query = getEntityManager()
                .createQuery("SELECT conta.dtRifConta FROM OrgAccordoEnte acc, " + " OrgStrut str "
                        + " JOIN MonContaUdDocComp conta on (conta.idStrut = str.idStrut) "
                        + " WHERE str.idEnteConvenz = acc.orgEnteSiam.idEnteSiam "
                        + " and acc.idAccordoEnte = :idAccordoEnte "
                        + "ORDER BY conta.dtRifConta DESC ");
        query.setParameter("idAccordoEnte", idAccordoEnte.longValue());
        List<Date> list = query.getResultList();
        if (list != null && !list.isEmpty()) {
            return list.get(0);
    ...
    public Object[] getOccupStorageGestore(String dtDecAccordoCorrente,
    ...
    public List<Object[]> getReportStorageExtraRer(List<String> cdTipoAccordo) {
        String queryNativeSQL = "SELECT OCCUP.AMBIENTE_ENTE, OCCUP.DIM_BYTES_MEDIA_ANNO, "
                ...
                + "TO_CHAR(OCCUP.DT_DEC_ACCORDO_INFO_ACC,'DD/MM/YYYY'), TO_CHAR(OCCUP.DT_SCAD_ACCORDO_ACC,'DD/MM/YYYY'), "
                + "TO_CHAR(OCCUP.DT_DEC_ACCORDO_ACC,'DD/MM/YYYY'), TO_CHAR(OCCUP.DT_FINE_VALID_ACCORDO_ACC,'DD/MM/YYYY') "
    ...
    public static String STORAGE_GESTORE = "SELECT "
            ...
            + " and acc.id_ente_convenz_gestore = :idEnteConvenzGestore " + " ) struts " + "WHERE "
    ...
    public List<BigDecimal> getAbilitazioniDaCancellare(List<BigDecimal> idAppartCollegEntiList) {
        Query q = getEntityManager().createQuery("SELECT u FROM UsrVAbilEnteCollegToDel u "
                + "WHERE u.idAppartCollegEnti IN :idAppartCollegEntiList ");

        q.setParameter("idAppartCollegEntiList", idAppartCollegEntiList);

        List<UsrVAbilEnteCollegToDel> abilEnteCollegToDelList = (List<UsrVAbilEnteCollegToDel>) q
                .getResultList();
