...
public class EntiNonConvenzionatiHelper extends GenericHelper {
    ...
    public OrgAmbitoTerrit getOrgAmbitoTerritByCode(String cdAmbitoTerritoriale) {
        // TODO: Bisogna chiedere a Sandro di fare un sinonimo per questa tabella, così non romperà più le palle per
        // mettere sto alias a SACER
        Query query = getEntityManager()
                .createQuery("SELECT a FROM OrgAmbitoTerrit a WHERE a.cdAmbitoTerrit LIKE :cdAmbitoTerritoriale");
    ...
    public OrgEnteSiam getOrgEnteSiam(String nmEnteSiam) {
        ...
        if (StringUtils.isNotBlank(nmEnteSiam)) {
            Query query = getEntityManager()
                    .createQuery("SELECT ente FROM OrgEnteSiam ente WHERE ente.nmEnteSiam = :nmEnteSiam");
    ...
    public OrgEnteSiam getOrgEnteConvenzByTiEnteConvenz(TiEnteConvenz tiEnteConvenz) {
        ...
        if (tiEnteConvenz != null) {
            Query query = getEntityManager()
                    .createQuery("SELECT ente FROM OrgEnteSiam ente " + "WHERE ente.tiEnteConvenz = :tiEnteConvenz ");
    ...
    public List<OrgEnteSiam> getOrgEnteNonConvenzList(BigDecimal idEnteNonConvenzDaEscludere) {
        ...
        Query query = getEntityManager().createQuery(queryStr);
        if (idEnteNonConvenzDaEscludere != null) {
            query.setParameter("idEnteNonConvenzDaEscludere", longFrom(idEnteNonConvenzDaEscludere));
        }
        List<OrgEnteSiam> list = query.getResultList();
        return list;
    }
    ...
    public List<OrgVRicEnteNonConvenz> retrieveOrgEnteNonConvenzList(String nmEnteSiam, BigDecimal idUserIamCor,
            // BigDecimal idAmbienteEnteConvenz,
            String flEnteCessato, List<BigDecimal> idArchivista, String noArchivista, Date dataOdierna,
        ...
        if (StringUtils.isNotBlank(flEnteCessato)) {
            if (flEnteCessato.equals("1")) {
                ...
                queryStr.append(clause).append("(ente.dtCessazione IS NULL OR ente.dtCessazione > :dataOdierna)");
            }
            clause = " AND ";
        }
    ...
    public boolean existsEnteConvenzOrgEnteCorrisp(BigDecimal idOrganizIam, BigDecimal idEnteSiamProdutCorrisp) {
    ...
    public List<OrgVigilEnteProdut> retrieveOrgVigilEnteProdut(BigDecimal idAccordoVigil) {
        Query query = getEntityManager().createQuery("SELECT vigilEnteProdut FROM OrgVigilEnteProdut vigilEnteProdut "
    ...
    public List<OrgVRicEnteNonConvenz> retrieveEntiNonConvenzAbilitati(BigDecimal idUserIam) {
        Query query = getEntityManager()
                .createQuery("SELECT ricEnteNonConvenz FROM OrgVRicEnteNonConvenz ricEnteNonConvenz "
     ...
     */
    @Deprecated
    public List<OrgVRicEnteNonConvenz> retrieveOrgVRicEnteNonConvenzByAmbiente(BigDecimal idAmbienteEnteConvenz) {
        Query query = getEntityManager().createQuery(
    ...
    public boolean existsEnteSuptPerEnteFornit(BigDecimal idEnteFornitEst, BigDecimal idEnteProdut, Date dtIniValSupt,
            Date dtFinValSupt, BigDecimal idSuptEstEnteConvenzDaEscludere) {
        String queryStr = "SELECT 1 FROM OrgSuptEsternoEnteConvenz suptEstEnteConvenz "
                ...
                + "AND suptEstEnteConvenz.orgEnteSiamByIdEnteProdut.idEnteSiam = :idEnteProdut " + "AND ( "
        ...
        if (idSuptEstEnteConvenzDaEscludere != null) {
            queryStr = queryStr + "AND suptEstEnteConvenz.idSuptEstEnteConvenz != :idSuptEstEnteConvenzDaEscludere ";
        }
        Query query = getEntityManager().createQuery(queryStr);
        query.setParameter("idEnteFornitEst", longFrom(idEnteFornitEst));
        ...
        if (idSuptEstEnteConvenzDaEscludere != null) {
            query.setParameter("idSuptEstEnteConvenzDaEscludere", longFrom(idSuptEstEnteConvenzDaEscludere));
        }
