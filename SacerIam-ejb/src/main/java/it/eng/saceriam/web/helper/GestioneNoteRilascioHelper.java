...
public class GestioneNoteRilascioHelper {
    ...
    public List<AplNotaRilascio> getAplNoteRilascioList(GestioneNoteRilascioForm.FiltriNoteRilascio filtriNoteRilascio)
            throws EMFError {
        return getAplNoteRilascioList(filtriNoteRilascio.getNm_applic().parse(),
                filtriNoteRilascio.getCd_versione().parse(), filtriNoteRilascio.getDt_versione_da().parse(),
                filtriNoteRilascio.getDt_versione_a().parse(), filtriNoteRilascio.getBl_nota().parse(),
                filtriNoteRilascio.getDs_evidenza().parse());
    }

    public List<AplNotaRilascio> getAplNoteRilascioList(BigDecimal idApplic, String cdVersione, Date dataVersioneDa,
            Date dataVersioneA, String blNota, String dsEvidenza) {
