 ...
 * @author Quaranta_M
 *
 * La trasformazione funziona purché siano soddisatte le seguenti condizioni: - nomeRowBean = nome
 * Entity + "RowBean" (NB: Dali tronca una eventuale 's' posta alla fine del nome della entity) -
 * nomeTableBean = nome Entity + "TableBean" - i nomi delle variabili degli oggetti referenziati
 * dalle entity (e le PK di tali oggetti) hanno la parte finale del nome uguale alle FK dei rowBean
...
public class Transform {
     ...
     *
     * @param entities la lista di entity da trasformare
     *
     * @return il rowBean trasformato
     *
     * @throws ClassNotFoundException    errore generico
     * @throws NoSuchMethodException     errore generico
     * @throws InstantiationException    errore generico
     * @throws IllegalAccessException    errore generico
     * @throws IllegalArgumentException  errore generico
     ...
     *
     * @param entity oggetto da trasformare
     *
     * @return il rowBean trasformato
     *
     * @throws ClassNotFoundException    errore generico
     ...
     *
     * <strong>UTILIZZARE ESCLUSIVAMENTE IN CASO DI NUOVI INSERIMENTI (PERSIST). NON UTILIZZARE IN
     * CASO DI UPDATE</strong>
     *
     * @param rowBean bean da trasformare
     *
