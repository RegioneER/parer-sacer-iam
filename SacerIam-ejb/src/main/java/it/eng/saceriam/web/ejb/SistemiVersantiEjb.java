...
public class SistemiVersantiEjb {
    ...
    /**
     * Metodo che ritorna la lista dei sistemi versanti in base ai filtri passati in input
     * attraverso la chiamata al relativo metodo dell'ejb helper.
     *
     * @param filtri    bean {@link FiltriSistemiVersanti}
    ...
    /**
     * Ritorna il tableBean con tutti i sistemi versanti dipendendi: - dal tipo user - dall'ente di
     * appartenenza utente - validi alla data odierna
     *
     * @param tipoUser   tipo user
     * @param idEnteUser id ente
     *
    ...
    /**
     * Ritorna il rowBean del sistema versante presente in AplVRicSistemaVersante passati in
     * ingresso i campi chiave
     *
    ...
    /**
     * Ritorna il tableBean contenente, per il sistema versante dato in input, la lista di utenti
     * archivisti
     *
     * @param idSistemaVersante id sistema versante
     *
    ...
    /**
     * Ritorna il tableBean contenente, per il sistema versante dato in input, la lista dei
     * referenti della ditta produttrice
     *
     * @param idSistemaVersante id sistema versante
     *
     * @return il tableBean della lista
     ...
     *
     * @param idSistemaVersArkRif id sistema versante archiviazione
     *
     * @throws ParerUserError errore generico
     */
     ...
     *
     * @param idSistemaVersanteUserRef id sistema versante
     *
     * @throws ParerUserError errore generico
     */
    @TransactionAttribute(TransactionAttributeType.REQUIRES_NEW)
