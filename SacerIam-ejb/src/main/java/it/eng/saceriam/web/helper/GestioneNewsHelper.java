...
public class GestioneNewsHelper {
    ...
    public List<AplNews> getAplNewsList(GestioneNewsForm.FiltriNews filtriNews) throws EMFError {
        return getAplNewsList(filtriNews.getDs_oggetto_filter().parse(), filtriNews.getDt_ini_pubblic_filter().parse(),
    ...
    public void deleteAplNewsApplicList(long idNews) {
        String queryStr = "DELETE FROM AplNewsApplic aplNewsApplic " + "WHERE aplNewsApplic.aplNew.idNews = :idNews ";
        Query query = entityManager.createQuery(queryStr);
