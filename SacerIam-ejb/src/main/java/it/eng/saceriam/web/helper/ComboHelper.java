 ...
 * persistenza su DB per le operazioni CRUD su oggetti di
 */
@Stateless
@LocalBean
public class ComboHelper {
    ...
    /**
     * Metodo che ritorna la lista delle applicazioni ordinate per nome in base alle abilitazioni
     * dell'utente "amministratore" (quello corrente)
     *
     * @deprecated il parametro idUserAdmin non viene mai usato, richiamare il metodo senza questo
     *             parametro
     *
    ...
    /**
     * Ritorna la lista di applicazioni per le quali l'utente corrente è abilitato e che mettano a
     * disposizione la pagina di informativa sulla privacy
     *
     * @param idUserIamCorrente id user iam corrente
     *
	...
	String queryStr = "SELECT usoApplic.aplApplic " + "FROM UsrUsoUserApplic usoApplic "
		+ "WHERE usoApplic.usrUser.idUserIam = :idUserIamCorrente "
		+ "AND usoApplic.aplApplic.nmApplic NOT LIKE :nmApplic "
		+ "ORDER BY usoApplic.aplApplic.nmApplic ";
	Query query = em.createQuery(queryStr);
	query.setParameter("idUserIamCorrente", idUserIamCorrente);
    ...
    /**
     * Metodo che ritorna la lista delle applicazioni ordinate per nome in base all'ente a cui
     * appartiene l'utente
     *
     * @deprecated il parametro isEnteFornitoreEsterno non è mai usato
     *
     * @param idUserIamCorrente        id user IAM
     * @param isAppartEnteConvenzAdmin id ente di appartenenza
     * @param isEnteOrganoVigilanza    true se ente organo vigilanza
     * @param isEnteFornitoreEsterno   true se ente fornitore esterno
     *
     * @return la lista delle applicazioni
     *
     */
    @Deprecated
    public List<AplApplic> getAplApplicAbilitateUtenteList(long idUserIamCorrente,
	    boolean isAppartEnteConvenzAdmin, boolean isEnteOrganoVigilanza,
	    boolean isEnteFornitoreEsterno) {
	return getAplApplicAbilitateUtenteList(idUserIamCorrente, isAppartEnteConvenzAdmin,
