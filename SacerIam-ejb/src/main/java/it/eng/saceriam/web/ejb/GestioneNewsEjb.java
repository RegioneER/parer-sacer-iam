...
public class GestioneNewsEjb {
    ...
    public AplNewsTableBean getAplNewsTableBean(GestioneNewsForm.FiltriNews filtriNews)
	    throws EMFError {
    ...
    public void updateAplNews(BigDecimal idNews, AplNewsRowBean newsRowBean,
	    AplApplicTableBean applicTableBean) throws IncoherenceException, EMFError {
	AplNews news = new AplNews();
	List<AplNewsApplic> newsApplicList = new ArrayList<>();
	List<AplApplic> applicList = new ArrayList<>();
	try {
