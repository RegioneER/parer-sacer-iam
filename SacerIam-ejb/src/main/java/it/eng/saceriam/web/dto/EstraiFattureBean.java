...
public class EstraiFattureBean implements Comparable<EstraiFattureBean> {
    ...
    public EstraiFattureBean(GestioneFatturazioneServiziForm.ListaEstraiRigheFatture detail)
	    throws EMFError {
	...
	if (riga instanceof EstraiFattureBean) {
	    ...
	    return Objects.equals(rigaFattura.getNm_ente_convenz(), this.nm_ente_convenz)
		    ...
		    && Objects.equals(rigaFattura.getNm_servizio_erogato_completo(),
			    this.nm_servizio_erogato_completo)
		    ...
		    && ObjectUtils.compare(rigaFattura.getIm_servizio_fattura(),
			    this.im_servizio_fattura) == 0
		    && ObjectUtils.compare(rigaFattura.getIm_totale(), this.im_totale) == 0
		    && Objects.equals(rigaFattura.getCd_iva(), this.cd_iva)
		    && Objects.equals(rigaFattura.getConto_tesoreria_unica(),
			    this.conto_tesoreria_unica)
