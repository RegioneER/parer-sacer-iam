...
public class ParerErrorSeverity {
    /**
     * Ritorna un <code>boolean</code> con il seguente significato: <em>true</em> il parametro severity in input �
     * valido. <em>false</em> il parametro severity in input non � valido.
     * 
     * @param severity
     *            livello verifica
     * 
