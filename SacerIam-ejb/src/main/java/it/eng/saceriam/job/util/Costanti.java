...
public class Costanti {
    ...
    // COSTANTI DI ERRORE INSERIMENTO, MODIFICA, CANCELLAZIONE UTENTE MANDATI IN RISPOSTA DAL WS
    // (Sacer, SacerPing,...)
    ...
    public static final String REPLICA_UTENTE_001 = "REPLICA-UTENTE-001";
}
