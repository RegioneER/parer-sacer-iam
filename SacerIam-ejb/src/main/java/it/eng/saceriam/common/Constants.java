...
public class Constants {
    ...
    public enum NomiJob {
        ...
        REPLICA_UTENTI, ALLINEAMENTO_LOG, INIZIALIZZAZIONE_LOG, WS_MONITORAGGIO_STATUS, SCADENZA_FATTURE,
        ELIMINA_REPLICHE_UTENTI;
        ...
        public static NomiJob[] getComboSchedulazioniJob() {
            return getEnums(REPLICA_UTENTI, ALLINEAMENTO_LOG, INIZIALIZZAZIONE_LOG, WS_MONITORAGGIO_STATUS,
