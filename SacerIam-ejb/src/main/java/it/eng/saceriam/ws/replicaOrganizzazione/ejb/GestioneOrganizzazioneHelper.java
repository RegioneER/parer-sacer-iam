...
public class GestioneOrganizzazioneHelper extends GenericHelper {
     ...
     * relativa ad una organizzazione "padre" passata come parametro di ingresso
     *
     * @param idOrganizIam id organizzazione padre
     *
    ...
    public int[] updateOrganizIam(ModificaOrganizzazioneExt moExt,
        ...
        try {
            ...
            // MAC #39357 - esecuzione del flush per garantire che l'UPDATE del padre
            // (organiz.setUsrOrganizIam)
            // sia scritto su DB prima che vengano interrogate le viste per il calcolo utenti
            // (impatto su ALL_ORG_CHILD)
            getEntityManager().flush();
            // *** AGGIUNTA FONDAMENTALE ***
            // Pulisco il contesto di persistenza. Questo stacca tutte le entità gestite.
            // La prossima query (getUsersOnDich) sarà costretta a leggere dal DB
            // e istanziare nuovi oggetti con i valori aggiornati della vista.
