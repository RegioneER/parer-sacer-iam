...
public class AllineaRuoloInput implements Serializable {
    ...
    public AllineaRuoloInput(String nmSistemaChiamante, String nmUseridCor, String nmRuolo,
	    String dsRuolo, String tiRuolo, ListaCategRuolo listaCategRuolo,
	    ListaApplic listaApplic) {
	...
	return "AllineaRuoloInput{" + "nmSistemaChiamante=" + nmSistemaChiamante + ", nmUseridCor="
		+ nmUseridCor + ", nmRuolo=" + nmRuolo + ", dsRuolo=" + dsRuolo + ", tiRuolo="
		+ tiRuolo + ", listaCategRuolo=" + listaCategRuolo + ", listaApplic=" + listaApplic
		+ '}';
    }
