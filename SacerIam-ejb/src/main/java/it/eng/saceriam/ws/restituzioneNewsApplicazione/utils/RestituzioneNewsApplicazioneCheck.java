...
public class RestituzioneNewsApplicazioneCheck {
    ...
    private static final Logger log = LoggerFactory.getLogger(RestituzioneNewsApplicazioneCheck.class);
    ...
    public RestituzioneNewsApplicazioneCheck(RestituzioneNewsApplicazioneExt restituzioneNewsApplicazioneExt,
            RispostaWSRestituzioneNewsApplicazione rispostaWs) {
    ...
    private void setRispostaWsError(SeverityEnum sev, EsitoServizio esito) {
        ...
        rispostaWs.getRestituzioneNewsApplicazioneRisposta().setCdErr(rispostaControlli.getCodErr());
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.RECUP_002, nmApplic));
