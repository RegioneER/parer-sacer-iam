...
public class ControlliWS {
    ...
    /**
     * Verifica su IAM l'esistenza di una organizzazione appartenente all'applicazione in input con
     * l'identificazione in input e il suo tipo
     *
     * @param nmApplic        nome applicazione
     * @param idOrganizApplic l'id associato all'organizzazione all'applicazione
     ...
     * @param nmTipoOrganiz nome tipo organizzazione
     *
     * @return RispostaControlli.isrBoolean() == true in caso la verifica dia esito positivo (tipo
     ...
     *
     * @param listaTipiDato lista tipi dato {@link ListaTipiDato}
     * @param nmApplic      nome applicazione
     *
     ...
     *
     * @param nmApplic il nome dell'applicazione da verificare
     *
     * @return RispostaControlli contenente l'esito del controllo e, in caso positivo,
     *         l'applicazione
     */
