...
public class InserimentoOrganizzazioneEjb {
    ...
    public InserimentoOrganizzazioneRisposta inserimentoOrganizzazione(String nmApplic,
	...
	InserimentoOrganizzazioneInput ioInput = new InserimentoOrganizzazioneInput(nmApplic,
		idOrganizApplic, nmTipoOrganiz, idEnteConserv, idEnteGestore, idOrganizApplicPadre,
	...
	if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
	    ...
	    InserimentoOrganizzazioneCheck checker = new InserimentoOrganizzazioneCheck(ioExt,
		    rispostaWs);
	...
	if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
		...
		if (idEnteConvenz != null && dtIniVal != null && dtFineVal != null) {
		    ...
		    /*
		     * Scrivo nel log dell'ente convenzionato l'inserimento
		     * dell'**********UNICA********** nuova associazione struttura - ente
		     * convenzionato
		     */
		...
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setNmApplic(ioInput.getNmApplic());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setIdOrganizApplic(ioInput.getIdOrganizApplic());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setNmTipoOrganiz(ioInput.getNmTipoOrganiz());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setIdOrganizApplicPadre(ioInput.getIdOrganizApplicPadre());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setNmTipoOrganizPadre(ioInput.getNmTipoOrganizPadre());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setNmOrganiz(ioInput.getNmOrganiz());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setDsOrganiz(ioInput.getDsOrganiz());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setIdEnteConvenz(ioInput.getIdEnteConvenz());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setDtIniVal(ioInput.getDtIniVal());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setDtFineVal(ioInput.getDtFineVal());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setListaTipiDato(ioInput.getListaTipiDato());
		...
		rispostaWs.getInserimentoOrganizzazioneRisposta()
			.setCdErr(rispostaWs.getErrorCode());
		rispostaWs.getInserimentoOrganizzazioneRisposta()
