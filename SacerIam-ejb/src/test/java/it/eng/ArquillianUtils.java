...
public abstract class ArquillianUtils {
    ...
    public static JavaArchive createPaginatorJavaArchive() {
        final JavaArchive paginatorArchive = ShrinkWrap.create(JavaArchive.class, "paginator.jar")
                .addPackages(true, "it.eng.paginator")
    ...
    public static JavaArchive createJbossTimerArchive() {
        final JavaArchive timersArchive = ShrinkWrap.create(JavaArchive.class, "timers.jar")
                .addPackages(true, "it.eng.parer.jboss.timer").addPackages(true, "it.eng.parer.jboss.timers")
    ...
    public static JavaArchive getSacerIamArchive(Class clazz) {
        ...
        javaArchive
                ...
                .addAsResource("META-INF/xmldbNativeQueries/xmlQueries.xml").addPackage("it.eng.sequences.hibernate");
        javaArchive.addClasses(it.eng.paginator.hibernate.OracleSqlInterceptor.class, ArquillianUtils.class,
                it.eng.saceriam.web.util.Transform.class, it.eng.saceriam.helper.GenericHelper.class,
                it.eng.saceriam.helper.HelperInterface.class, org.apache.commons.lang3.StringUtils.class,
                it.eng.spagoCore.error.EMFError.class, it.eng.RollbackException.class, it.eng.ExpectedException.class,
                it.eng.saceriam.helper.ParamHelper.class);
        javaArchive.addPackages(true, "it.eng.spagoLite", "it.eng.saceriam.slite.gen", "it.eng.saceriam.entity",
                "it.eng.saceriam.viewEntity", "it.eng.saceriam.grantedEntity", "it.eng.paginator",
                "it.eng.saceriam.exception", "it.eng.saceriam.common");
        if (clazz != null) {
