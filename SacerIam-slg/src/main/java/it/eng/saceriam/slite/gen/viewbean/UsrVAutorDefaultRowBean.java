 ...
 *
 */
public class UsrVAutorDefaultRowBean extends BaseRow
	implements BaseRowInterface, JEEBaseRowInterface {

    /*
     * @Generated( value = "it.eg.dbtool.db.oracle.beangen.Oracle4JPAClientBeanGen$ViewBeanWriter",
     * comments = "This class was generated by OraTool", date = "Wednesday, 6 November 2013 16:43" )
     */
	...
	this.setIdUserIam(entity.getUsrVAutorDefaultId() == null ? null
		: entity.getUsrVAutorDefaultId().getIdUserIam());
	...
	this.setIdApplic(entity.getUsrVAutorDefaultId() == null ? null
		: entity.getUsrVAutorDefaultId().getIdApplic());
	this.setNmApplic(entity.getNmApplic());
	this.setIdRuolo(entity.getUsrVAutorDefaultId() == null ? null
		: entity.getUsrVAutorDefaultId().getIdRuolo());
	this.setNmRuolo(entity.getNmRuolo());
	this.setTiDichAutor(entity.getUsrVAutorDefaultId() == null ? null
		: entity.getUsrVAutorDefaultId().getTiDichAutor());
	this.setIdAutor(entity.getUsrVAutorDefaultId() == null ? null
		: entity.getUsrVAutorDefaultId().getIdAutor());
