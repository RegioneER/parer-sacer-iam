...
import it.eng.saceriam.viewEntity.UsrVAllorgchildByProdut;
import it.eng.saceriam.viewEntity.UsrVAllorgchildByProdutId;
...
/**
 * RowBean per la tabella Usr_V_Allorgchild_By_Produt
 *
 */
public class UsrVAllorgchildByProdutRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public UsrVAllorgchildByProdutRowBean() {
        super();
    }
    ...
    public void entityToRowBean(Object obj) {
        UsrVAllorgchildByProdut entity = (UsrVAllorgchildByProdut) obj;
        this.setIdUserIamCor(entity.getUsrVAllorgchildByProdutId() == null ? null
                : entity.getUsrVAllorgchildByProdutId().getIdUserIamCor());
        this.setIdApplic(entity.getIdApplic());
        this.setNmApplic(entity.getNmApplic());
        this.setIdEnteProdut(entity.getIdEnteProdut());
        this.setIdOrganizIamEnte(entity.getUsrVAllorgchildByProdutId() == null ? null
                : entity.getUsrVAllorgchildByProdutId().getIdOrganizIamEnte());
    ...
    @Override
    public UsrVAllorgchildByProdut rowBeanToEntity() {
        UsrVAllorgchildByProdut entity = new UsrVAllorgchildByProdut();
        entity.setUsrVAllorgchildByProdutId(new UsrVAllorgchildByProdutId());
        entity.getUsrVAllorgchildByProdutId().setIdUserIamCor(this.getIdUserIamCor());
        entity.setIdApplic(this.getIdApplic());
        entity.setNmApplic(this.getNmApplic());
        entity.setIdEnteProdut(this.getIdEnteProdut());
        entity.getUsrVAllorgchildByProdutId().setIdOrganizIamEnte(this.getIdOrganizIamEnte());
