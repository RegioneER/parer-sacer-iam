...
public class OrgVOccupStorageAccordoTableDescriptor extends TableDescriptor {
    ...
    static {
        map.put(COL_AMBIENTE_ENTE, new ColumnDescriptor(COL_AMBIENTE_ENTE, Types.VARCHAR, 357, true));
        map.put(COL_CD_TIPO_ACCORDO, new ColumnDescriptor(COL_CD_TIPO_ACCORDO, Types.VARCHAR, 357, true));
        ...
        map.put(COL_MESI_VALIDITA, new ColumnDescriptor(COL_MESI_VALIDITA, Types.DECIMAL, 22, true));
        ...
        map.put(COL_DIM_BYTES_MEDIA_ANNO, new ColumnDescriptor(COL_DIM_BYTES_MEDIA_ANNO, Types.DECIMAL, 22, true));
        map.put(COL_NI_FASCIA_ACCORDO_A, new ColumnDescriptor(COL_NI_FASCIA_ACCORDO_A, Types.DECIMAL, 22, true));
        map.put(COL_DT_FINE_ACCORDO, new ColumnDescriptor(COL_DT_FINE_ACCORDO, Types.TIMESTAMP, 7, true));
        map.put(COL_NI_FASCIA_ACCORDO_A, new ColumnDescriptor(COL_NI_FASCIA_ACCORDO_A, Types.DECIMAL, 22, true));
        map.put(COL_FASCIA_ACCORDO, new ColumnDescriptor(COL_FASCIA_ACCORDO, Types.VARCHAR, 69, true));
        map.put(COL_FASCIA_OCCUPAZIONE, new ColumnDescriptor(COL_FASCIA_OCCUPAZIONE, Types.VARCHAR, 109, true));
