 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Abil_Organiz_Nolast_Liv
 *
 */
public class UsrVAbilOrganizNolastLivTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Abil_Organiz_Nolast_Liv /**/";
    public static final String TABLE_NAME = "Usr_V_Abil_Organiz_Nolast_Liv";
