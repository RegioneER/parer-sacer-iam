 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Allorgchild_By_Vigil_Cor
 *
 */
public class UsrVAllorgchildByVigilCorTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Allorgchild_By_Vigil_Cor /**/";
    public static final String TABLE_NAME = "Usr_V_Allorgchild_By_Vigil_Cor";
