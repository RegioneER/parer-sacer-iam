 ...
 *
 */
public class OrgServizioFatturaRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public void entityToRowBean(Object obj) {
        ...
        if (entity.getOrgServizioErog() != null) {
            this.setIdServizioErogato(new BigDecimal(entity.getOrgServizioErog().getIdServizioErogato()));
        }
    ...
    public OrgServizioFattura rowBeanToEntity() {
        ...
        if (this.getIdServizioErogato() != null) {
            ...
            entity.getOrgServizioErog().setIdServizioErogato(this.getIdServizioErogato().longValue());
        }
