...
public class OrgEnteSiamRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
	...
	if (entity.getOrgEnteSiamByIdEnteConvenzNuovo() != null) {
	    this.setIdEnteConvenzNuovo(
		    new BigDecimal(entity.getOrgEnteSiamByIdEnteConvenzNuovo().getIdEnteSiam()));

	}
	if (entity.getOrgEnteSiamByIdEnteConvenzCreazione() != null) {
	    this.setIdEnteConvenzCreazione(new BigDecimal(
		    entity.getOrgEnteSiamByIdEnteConvenzCreazione().getIdEnteSiam()));

	}
	if (entity.getOrgEnteSiamByIdEnteProdutCorrisp() != null) {
	    this.setIdEnteProdutCorrisp(
		    new BigDecimal(entity.getOrgEnteSiamByIdEnteProdutCorrisp().getIdEnteSiam()));
	...
	if (entity.getTiEnteConvenz() != null) {
	    this.setTiEnteConvenz(
		    entity.getTiEnteConvenz() == null ? null : entity.getTiEnteConvenz().name());
	}
	if (entity.getTiEnteNonConvenz() != null) {
	    this.setTiEnteNonConvenz(entity.getTiEnteNonConvenz() == null ? null
		    : entity.getTiEnteNonConvenz().name());
	}
	...
	if (this.getIdEnteConvenzNuovo() != null) {
	    ...
	    entity.getOrgEnteSiamByIdEnteConvenzNuovo()
		    .setIdEnteSiam(this.getIdEnteConvenzNuovo().longValue());
	}
	if (this.getIdEnteConvenzCreazione() != null) {
	    if (entity.getOrgEnteSiamByIdEnteConvenzCreazione() == null) {
		entity.setOrgEnteSiamByIdEnteConvenzCreazione(new OrgEnteSiam());
	    }
	    entity.getOrgEnteSiamByIdEnteConvenzCreazione()
		    .setIdEnteSiam(this.getIdEnteConvenzCreazione().longValue());
	}
	if (this.getIdEnteProdutCorrisp() != null) {
	    if (entity.getOrgEnteSiamByIdEnteProdutCorrisp() == null) {
		entity.setOrgEnteSiamByIdEnteProdutCorrisp(new OrgEnteSiam());
	    }
	    entity.getOrgEnteSiamByIdEnteProdutCorrisp()
		    .setIdEnteSiam(this.getIdEnteProdutCorrisp().longValue());
	}
	...
	if (this.getIdAmbienteEnteConvenz() != null) {
	    ...
	    entity.getOrgAmbienteEnteConvenz()
		    .setIdAmbienteEnteConvenz(this.getIdAmbienteEnteConvenz().longValue());
	}
