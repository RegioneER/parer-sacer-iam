 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Lis_Enti_Siam_App_Ente
 *
 */
public class UsrVLisEntiSiamAppEnteTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Lis_Enti_Siam_App_Ente /**/";
    public static final String TABLE_NAME = "Usr_V_Lis_Enti_Siam_App_Ente";
