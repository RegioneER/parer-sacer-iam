 ...
 *
 */
public class UsrVAllorgchildByConservRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public UsrVAllorgchildByConserv rowBeanToEntity() {
        ...
        entity.getUsrVAllorgchildByConservId().setIdOrganizIamAmbEnte(this.getIdOrganizIamAmbEnte());
