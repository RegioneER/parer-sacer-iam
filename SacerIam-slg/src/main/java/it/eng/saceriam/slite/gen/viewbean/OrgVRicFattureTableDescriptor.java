 ...
 * @author Sloth
 *
 *         Bean per la tabella ORG_V_RIC_FATTURE
 *
 */
public class OrgVRicFattureTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from ORG_V_RIC_FATTURE /**/";
	...
	map.put(COL_IM_TOT_PAGATO,
		new ColumnDescriptor(COL_IM_TOT_PAGATO, Types.DECIMAL, 22, true));
	map.put(COL_ID_STATO_FATTURA_ENTE,
		new ColumnDescriptor(COL_ID_STATO_FATTURA_ENTE, Types.DECIMAL, 22, true));
