 ...
 *
 */
public class UsrVCheckDichAbilEnteRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public UsrVCheckDichAbilEnte rowBeanToEntity() {
        ...
        entity.getUsrVCheckDichAbilEnteId().setIdDichAbilEnteAggiunta(this.getIdDichAbilEnteAggiunta());
