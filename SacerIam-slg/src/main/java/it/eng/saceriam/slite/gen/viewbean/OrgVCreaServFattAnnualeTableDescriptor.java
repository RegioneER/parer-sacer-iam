 ...
 * @author Sloth
 *
 *         Bean per la tabella Org_V_Crea_Serv_Fatt_Annuale
 *
 */
public class OrgVCreaServFattAnnualeTableDescriptor extends TableDescriptor {

    /*
     * @Generated( value = "it.eg.dbtool.db.oracle.beangen.Oracle4JPAClientBeanGen$ViewBeanWriter",
     * comments = "This class was generated by OraTool", date = "Wednesday, 21 October 2020 18:49" )
     */

    public static final String SELECT = "Select * from Org_V_Crea_Serv_Fatt_Annuale /**/";
    public static final String TABLE_NAME = "Org_V_Crea_Serv_Fatt_Annuale";
