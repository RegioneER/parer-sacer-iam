 ...
 *
 */
public class OrgVCreaFatturaByFattRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public OrgVCreaFatturaByFatt rowBeanToEntity() {
        ...
        entity.getOrgVCreaFatturaByFattId().setIdFatturaEnteDaRicalc(this.getIdFatturaEnteDaRicalc());
