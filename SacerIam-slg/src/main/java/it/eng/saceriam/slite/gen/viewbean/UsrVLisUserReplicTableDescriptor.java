...
public class UsrVLisUserReplicTableDescriptor extends TableDescriptor {
	...
	map.put(COL_TI_STATO_REPLIC,
		new ColumnDescriptor(COL_TI_STATO_REPLIC, Types.VARCHAR, 20, true));
	map.put(COL_DT_LOG_USER_DA_REPLIC,
		new ColumnDescriptor(COL_DT_LOG_USER_DA_REPLIC, Types.TIMESTAMP, 7, true));
	...
	map.put(COL_DT_CHIUSURA_REPLICA,
		new ColumnDescriptor(COL_DT_CHIUSURA_REPLICA, Types.TIMESTAMP, 7, true));
    }
