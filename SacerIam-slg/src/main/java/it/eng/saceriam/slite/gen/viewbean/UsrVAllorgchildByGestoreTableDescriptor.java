 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Allorgchild_By_Gestore
 *
 */
public class UsrVAllorgchildByGestoreTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Allorgchild_By_Gestore /**/";
    public static final String TABLE_NAME = "Usr_V_Allorgchild_By_Gestore";
    ...
    static {
        ...
        map.put(COL_DS_CAUSALE_DICH, new ColumnDescriptor(COL_DS_CAUSALE_DICH, Types.VARCHAR, 28, true));
    }
