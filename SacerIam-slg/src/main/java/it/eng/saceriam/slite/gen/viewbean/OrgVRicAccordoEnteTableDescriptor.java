...
public class OrgVRicAccordoEnteTableDescriptor extends TableDescriptor {
     ...
     * comments = "This class was generated by OraTool", date = "Thursday, 16 December 2021 12:32" )
     */
	...
	map.put(COL_CD_REGISTRO_REPERTORIO,
		new ColumnDescriptor(COL_CD_REGISTRO_REPERTORIO, Types.VARCHAR, 100, true));
	map.put(COL_AA_REPERTORIO,
		new ColumnDescriptor(COL_AA_REPERTORIO, Types.DECIMAL, 22, true));
	map.put(COL_CD_KEY_REPERTORIO,
		new ColumnDescriptor(COL_CD_KEY_REPERTORIO, Types.VARCHAR, 100, true));
	...
	map.put(COL_DS_NOTA_FATTURAZIONE,
		new ColumnDescriptor(COL_DS_NOTA_FATTURAZIONE, Types.VARCHAR, 4000, true));
	...
	map.put(COL_FL_FASCIA_MANUALE,
		new ColumnDescriptor(COL_FL_FASCIA_MANUALE, Types.VARCHAR, 1, true));
	map.put(COL_FL_ESISTONO_SAE,
		new ColumnDescriptor(COL_FL_ESISTONO_SAE, Types.VARCHAR, 1, true));
	map.put(COL_FL_ESISTONO_SUE,
		new ColumnDescriptor(COL_FL_ESISTONO_SUE, Types.VARCHAR, 1, true));
	map.put(COL_TI_STATO_ACCORDO,
		new ColumnDescriptor(COL_TI_STATO_ACCORDO, Types.VARCHAR, 31, true));
    }
