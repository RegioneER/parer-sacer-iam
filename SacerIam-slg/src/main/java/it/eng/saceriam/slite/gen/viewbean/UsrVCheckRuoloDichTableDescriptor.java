 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Check_Ruolo_Dich
 *
 */
public class UsrVCheckRuoloDichTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Check_Ruolo_Dich /**/";
    public static final String TABLE_NAME = "Usr_V_Check_Ruolo_Dich";
    ...
    public static final String COL_ID_APPLIC_DICH = "id_applic_dich";
    ...
    static {
        ...
        map.put(COL_ID_APPLIC_DICH, new ColumnDescriptor(COL_ID_APPLIC_DICH, Types.DECIMAL, 22, true));
