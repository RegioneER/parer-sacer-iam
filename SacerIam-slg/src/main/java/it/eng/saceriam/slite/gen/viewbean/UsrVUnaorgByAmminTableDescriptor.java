 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Unaorg_By_Ammin
 *
 */
public class UsrVUnaorgByAmminTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Unaorg_By_Ammin /**/";
    public static final String TABLE_NAME = "Usr_V_Unaorg_By_Ammin";
