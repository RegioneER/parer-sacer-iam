...
public class AplVRicSistemaVersanteTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_SISTEMA_VERSANTE, new ColumnDescriptor(COL_DS_SISTEMA_VERSANTE, Types.VARCHAR, 254, true));
        map.put(COL_ID_ENTE_SIAM, new ColumnDescriptor(COL_ID_ENTE_SIAM, Types.DECIMAL, 22, true));
        map.put(COL_NM_PRODUTTORE, new ColumnDescriptor(COL_NM_PRODUTTORE, Types.VARCHAR, 254, true));
        map.put(COL_DS_VIA_SEDE_LEGALE, new ColumnDescriptor(COL_DS_VIA_SEDE_LEGALE, Types.VARCHAR, 254, true));
        map.put(COL_CD_CAP_SEDE_LEGALE, new ColumnDescriptor(COL_CD_CAP_SEDE_LEGALE, Types.VARCHAR, 5, true));
        map.put(COL_DS_CITTA_SEDE_LEGALE, new ColumnDescriptor(COL_DS_CITTA_SEDE_LEGALE, Types.VARCHAR, 254, true));
        ...
        map.put(COL_FL_INTEGRAZIONE, new ColumnDescriptor(COL_FL_INTEGRAZIONE, Types.VARCHAR, 1, true));
