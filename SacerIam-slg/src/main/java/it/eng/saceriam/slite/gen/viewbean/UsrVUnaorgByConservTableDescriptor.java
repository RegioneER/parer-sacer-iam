 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Unaorg_By_Conserv
 *
 */
public class UsrVUnaorgByConservTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Unaorg_By_Conserv /**/";
    public static final String TABLE_NAME = "Usr_V_Unaorg_By_Conserv";
