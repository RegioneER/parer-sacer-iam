...
import it.eng.saceriam.viewEntity.UsrVLisEntiSiamPerAzioId;
...
/**
 * RowBean per la tabella Usr_V_Lis_Enti_Siam_Per_Azio
 *
 */
public class UsrVLisEntiSiamPerAzioRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
    ...
    public UsrVLisEntiSiamPerAzioRowBean() {
        super();
    }
    ...
    public void entityToRowBean(Object obj) {
        UsrVLisEntiSiamPerAzio entity = (UsrVLisEntiSiamPerAzio) obj;
        this.setIdRichGestUser(entity.getIdRichGestUser());
        this.setIdUserIamCor(entity.getUsrVLisEntiSiamPerAzioId() == null ? null
                : entity.getUsrVLisEntiSiamPerAzioId().getIdUserIamCor());
        this.setIdEnteSiam(entity.getUsrVLisEntiSiamPerAzioId() == null ? null
                : entity.getUsrVLisEntiSiamPerAzioId().getIdEnteSiam());
    ...
    @Override
    public UsrVLisEntiSiamPerAzio rowBeanToEntity() {
        UsrVLisEntiSiamPerAzio entity = new UsrVLisEntiSiamPerAzio();
        entity.setUsrVLisEntiSiamPerAzioId(new UsrVLisEntiSiamPerAzioId());
        entity.setIdRichGestUser(this.getIdRichGestUser());
        entity.getUsrVLisEntiSiamPerAzioId().setIdUserIamCor(this.getIdUserIamCor());
        entity.getUsrVLisEntiSiamPerAzioId().setIdEnteSiam(this.getIdEnteSiam());
