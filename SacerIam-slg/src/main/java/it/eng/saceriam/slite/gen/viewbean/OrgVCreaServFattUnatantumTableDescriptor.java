 ...
 * @author Sloth
 *
 *         Bean per la tabella Org_V_Crea_Serv_Fatt_Unatantum
 *
 */
public class OrgVCreaServFattUnatantumTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Org_V_Crea_Serv_Fatt_Unatantum /**/";
    public static final String TABLE_NAME = "Org_V_Crea_Serv_Fatt_Unatantum";
