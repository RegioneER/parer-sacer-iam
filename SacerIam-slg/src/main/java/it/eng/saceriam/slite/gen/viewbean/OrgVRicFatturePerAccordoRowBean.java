...
/**
 * RowBean per la tabella Org_V_Ric_Fatture_Per_Accordo
 *
 */
public class OrgVRicFatturePerAccordoRowBean extends BaseRow
    ...
    public static final OrgVRicFatturePerAccordoTableDescriptor TABLE_DESCRIPTOR = new OrgVRicFatturePerAccordoTableDescriptor();

    public OrgVRicFatturePerAccordoRowBean() {
	super();
    }
	...
	OrgVRicFatturePerAccordo entity = (OrgVRicFatturePerAccordo) obj;
	...
	if (entity.getDtRegStatoFatturaEnte() != null) {
	    this.setDtRegStatoFatturaEnte(
		    new Timestamp(entity.getDtRegStatoFatturaEnte().getTime()));
	}
    ...
    @Override
    public OrgVRicFatturePerAccordo rowBeanToEntity() {
	OrgVRicFatturePerAccordo entity = new OrgVRicFatturePerAccordo();
