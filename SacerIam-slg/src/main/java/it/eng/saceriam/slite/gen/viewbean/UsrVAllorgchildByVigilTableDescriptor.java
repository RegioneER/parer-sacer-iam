 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Allorgchild_By_Vigil
 *
 */
public class UsrVAllorgchildByVigilTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Allorgchild_By_Vigil /**/";
    public static final String TABLE_NAME = "Usr_V_Allorgchild_By_Vigil";
    ...
    public static final String COL_ID_ENTE_PRODUT_VIGIL = "id_ente_produt_vigil";
    ...
    static {
        ...
        map.put(COL_ID_ENTE_ORGANO_VIGIL, new ColumnDescriptor(COL_ID_ENTE_ORGANO_VIGIL, Types.DECIMAL, 22, true));
        ...
        map.put(COL_ID_ENTE_PRODUT_VIGIL, new ColumnDescriptor(COL_ID_ENTE_PRODUT_VIGIL, Types.DECIMAL, 22, true));
        map.put(COL_DS_CAUSALE_DICH, new ColumnDescriptor(COL_DS_CAUSALE_DICH, Types.VARCHAR, 53, true));
    }
