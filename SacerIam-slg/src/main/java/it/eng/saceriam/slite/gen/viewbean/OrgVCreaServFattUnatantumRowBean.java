...
import it.eng.saceriam.viewEntity.OrgVCreaServFattUnatantumId;
...
/**
 * RowBean per la tabella Org_V_Crea_Serv_Fatt_Unatantum
 *
 */
public class OrgVCreaServFattUnatantumRowBean extends BaseRow
    ...
    public static OrgVCreaServFattUnatantumTableDescriptor TABLE_DESCRIPTOR = new OrgVCreaServFattUnatantumTableDescriptor();

    public OrgVCreaServFattUnatantumRowBean() {
	super();
    }
	...
	OrgVCreaServFattUnatantum entity = (OrgVCreaServFattUnatantum) obj;
	this.setIdFatturaEnte(entity.getOrgVCreaServFattUnatantumId() == null ? null
		: entity.getOrgVCreaServFattUnatantumId().getIdFatturaEnte());
	this.setIdAccordoEnte(entity.getIdAccordoEnte());
	this.setIdServizioErogato(entity.getOrgVCreaServFattUnatantumId() == null ? null
		: entity.getOrgVCreaServFattUnatantumId().getIdServizioErogato());
	this.setAaServizioFattura(entity.getOrgVCreaServFattUnatantumId() == null ? null
		: entity.getOrgVCreaServFattUnatantumId().getAaServizioFattura());
    ...
    @Override
    public OrgVCreaServFattUnatantum rowBeanToEntity() {
	OrgVCreaServFattUnatantum entity = new OrgVCreaServFattUnatantum();
	entity.setOrgVCreaServFattUnatantumId(new OrgVCreaServFattUnatantumId());
	entity.getOrgVCreaServFattUnatantumId().setIdFatturaEnte(this.getIdFatturaEnte());
	entity.setIdAccordoEnte(this.getIdAccordoEnte());
	entity.getOrgVCreaServFattUnatantumId().setIdServizioErogato(this.getIdServizioErogato());
	entity.getOrgVCreaServFattUnatantumId().setAaServizioFattura(this.getAaServizioFattura());
