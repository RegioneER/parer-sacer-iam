 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Abil_Ente_Sacer_Xstrut
 *
 */
public class UsrVAbilEnteSacerXstrutTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Abil_Ente_Sacer_Xstrut /**/";
    public static final String TABLE_NAME = "Usr_V_Abil_Ente_Sacer_Xstrut";
    ...
    public static final String COL_ID_ORGANIZ_APPLIC_PADRE = "id_organiz_applic_padre";
