 ...
 *
 */
public class UsrVAbilDatiToAddRowBean extends BaseRow
	...
	this.setIdUserIam(entity.getUsrVAbilDatiToAddId() == null ? null
		: entity.getUsrVAbilDatiToAddId().getIdUserIam());
	...
	this.setIdTipoDatoIam(entity.getUsrVAbilDatiToAddId() == null ? null
		: entity.getUsrVAbilDatiToAddId().getIdTipoDatoIam());
