...
public class UsrUserTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_EMAIL_SECONDARIA, new ColumnDescriptor(COL_DS_EMAIL_SECONDARIA, Types.VARCHAR, 254, false));
        ...
        map.put(COL_ID_STATO_USER_COR, new ColumnDescriptor(COL_ID_STATO_USER_COR, Types.DECIMAL, 22, false));
        map.put(COL_FL_RESP_ENTE_CONVENZ, new ColumnDescriptor(COL_FL_RESP_ENTE_CONVENZ, Types.VARCHAR, 1, false));
        map.put(COL_CD_PSW_DA_NOTIF, new ColumnDescriptor(COL_CD_PSW_DA_NOTIF, Types.VARCHAR, 100, false));
        map.put(COL_FL_ABIL_ENTI_COLLEG_AUTOM,
                new ColumnDescriptor(COL_FL_ABIL_ENTI_COLLEG_AUTOM, Types.VARCHAR, 1, false));
        map.put(COL_FL_ABIL_ORGANIZ_AUTOM, new ColumnDescriptor(COL_FL_ABIL_ORGANIZ_AUTOM, Types.VARCHAR, 1, false));
        map.put(COL_TIPO_AUTH, new ColumnDescriptor(COL_TIPO_AUTH, Types.VARCHAR, 20, false));
        map.put(COL_DL_CERT_CLIENT, new ColumnDescriptor(COL_DL_CERT_CLIENT, Types.VARCHAR, 4000, false));
