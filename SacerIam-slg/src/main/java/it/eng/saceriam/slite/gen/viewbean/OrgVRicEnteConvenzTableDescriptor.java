...
public class OrgVRicEnteConvenzTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DT_RICH_MODULO_INFO, new ColumnDescriptor(COL_DT_RICH_MODULO_INFO, Types.TIMESTAMP, 7, true));
        map.put(COL_FL_ESISTONO_MODULI, new ColumnDescriptor(COL_FL_ESISTONO_MODULI, Types.VARCHAR, 1, true));
        ...
        map.put(COL_TIPO_GESTIONE_ACCORDO, new ColumnDescriptor(COL_TIPO_GESTIONE_ACCORDO, Types.VARCHAR, 100, true));
        map.put(COL_FL_GEST_ACC_NO_RISP, new ColumnDescriptor(COL_FL_GEST_ACC_NO_RISP, Types.VARCHAR, 1, true));
        map.put(COL_TI_STATO_ACCORDO, new ColumnDescriptor(COL_TI_STATO_ACCORDO, Types.VARCHAR, 100, true));
