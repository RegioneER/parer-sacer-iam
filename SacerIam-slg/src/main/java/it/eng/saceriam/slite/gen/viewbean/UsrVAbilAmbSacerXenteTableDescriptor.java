 ...
 * @author Sloth
 *
 *         Bean per la tabella Usr_V_Abil_Amb_Sacer_Xente
 *
 */
public class UsrVAbilAmbSacerXenteTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Usr_V_Abil_Amb_Sacer_Xente /**/";
    public static final String TABLE_NAME = "Usr_V_Abil_Amb_Sacer_Xente";
