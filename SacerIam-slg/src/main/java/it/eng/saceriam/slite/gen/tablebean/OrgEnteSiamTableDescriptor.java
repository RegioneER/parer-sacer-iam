...
import static it.eng.saceriam.slite.gen.tablebean.OrgAccordoEnteTableDescriptor.COL_DT_RICH_MODULO_INFO;
...
public class OrgEnteSiamTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_NM_ENTE_SIAM, new ColumnDescriptor(COL_NM_ENTE_SIAM, Types.VARCHAR, 100, false));
        ...
        map.put(COL_DT_CESSAZIONE, new ColumnDescriptor(COL_DT_CESSAZIONE, Types.TIMESTAMP, 7, false));
        ...
        map.put(COL_ID_ENTE_CONVENZ_NUOVO, new ColumnDescriptor(COL_ID_ENTE_CONVENZ_NUOVO, Types.DECIMAL, 22, false));
        map.put(COL_ID_ENTE_CONVENZ_CREAZIONE,
                new ColumnDescriptor(COL_ID_ENTE_CONVENZ_CREAZIONE, Types.DECIMAL, 22, false));
        map.put(COL_ID_ENTE_PRODUT_CORRISP, new ColumnDescriptor(COL_ID_ENTE_PRODUT_CORRISP, Types.DECIMAL, 22, false));
        ...
        map.put(COL_TI_ENTE_CONVENZ, new ColumnDescriptor(COL_TI_ENTE_CONVENZ, Types.VARCHAR, 20, false));
        map.put(COL_TI_ENTE_NON_CONVENZ, new ColumnDescriptor(COL_TI_ENTE_NON_CONVENZ, Types.VARCHAR, 20, false));
        ...
        map.put(COL_TI_MOD_PAGAM, new ColumnDescriptor(COL_TI_MOD_PAGAM, Types.VARCHAR, 100, false));
    }
