...
public class OrgTariffaAaAccordoTableDescriptor extends TableDescriptor {
    ...
    static {
	map.put(COL_ID_TARIFFA_AA_ACCORDO,
		new ColumnDescriptor(COL_ID_TARIFFA_AA_ACCORDO, Types.DECIMAL, 22, true));
	map.put(COL_ID_AA_ACCORDO,
		new ColumnDescriptor(COL_ID_AA_ACCORDO, Types.DECIMAL, 22, false));
	map.put(COL_ID_TIPO_SERVIZIO,
		new ColumnDescriptor(COL_ID_TIPO_SERVIZIO, Types.DECIMAL, 22, false));
	map.put(COL_IM_TARIFFA_AA_ACCORDO,
		new ColumnDescriptor(COL_IM_TARIFFA_AA_ACCORDO, Types.DECIMAL, 22, false));
    }
