...
public class UsrVAbilDatiRowBean extends BaseRow implements BaseRowInterface, JEEBaseRowInterface {
	...
	this.setIdUserIam(entity.getUsrVAbilDatiId() == null ? null
		: entity.getUsrVAbilDatiId().getIdUserIam());
	...
	this.setIdTipoDatoIam(entity.getUsrVAbilDatiId() == null ? null
		: entity.getUsrVAbilDatiId().getIdTipoDatoIam());
