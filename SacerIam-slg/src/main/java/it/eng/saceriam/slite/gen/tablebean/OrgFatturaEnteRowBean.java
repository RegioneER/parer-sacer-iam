 ...
 *
 */
public class OrgFatturaEnteRowBean extends BaseRow
	...
	if (entity.getOrgFatturaEnte() != null) {
	    this.setIdFatturaEnteStornata(
		    new BigDecimal(entity.getOrgFatturaEnte().getIdFatturaEnte()));
	}
	...
	if (this.getIdFatturaEnteStornata() != null) {
	    ...
	    entity.getOrgFatturaEnte()
		    .setIdFatturaEnte(this.getIdFatturaEnteStornata().longValue());
	}
