...
public class OrgAccordoEnteTableDescriptor extends TableDescriptor {
     ...
     * comments = "This class was generated by OraTool", date = "Friday, 30 October 2020 09:45" )
     */
	...
	map.put(COL_DT_SCAD_ACCORDO,
		new ColumnDescriptor(COL_DT_SCAD_ACCORDO, Types.TIMESTAMP, 7, false));
	...
	map.put(COL_CD_REGISTRO_DETERMINA,
		new ColumnDescriptor(COL_CD_REGISTRO_DETERMINA, Types.VARCHAR, 100, false));
	map.put(COL_AA_DETERMINA, new ColumnDescriptor(COL_AA_DETERMINA, Types.DECIMAL, 22, false));
	map.put(COL_CD_KEY_DETERMINA,
		new ColumnDescriptor(COL_CD_KEY_DETERMINA, Types.VARCHAR, 100, false));
	map.put(COL_DT_DETERMINA,
		new ColumnDescriptor(COL_DT_DETERMINA, Types.TIMESTAMP, 7, false));
	map.put(COL_DS_NOTE_ACCORDO,
		new ColumnDescriptor(COL_DS_NOTE_ACCORDO, Types.VARCHAR, 4000, false));
	...
	map.put(COL_CD_RIF_CONTAB,
		new ColumnDescriptor(COL_CD_RIF_CONTAB, Types.VARCHAR, 254, false));
	...
	map.put(COL_DT_DEC_ACCORDO,
		new ColumnDescriptor(COL_DT_DEC_ACCORDO, Types.TIMESTAMP, 7, false));
	map.put(COL_DT_DEC_ACCORDO_INFO,
		new ColumnDescriptor(COL_DT_DEC_ACCORDO_INFO, Types.TIMESTAMP, 7, false));
	...
	map.put(COL_DS_ATTO_ACCORDO,
		new ColumnDescriptor(COL_DS_ATTO_ACCORDO, Types.VARCHAR, 254, false));
	map.put(COL_DT_ATTO_ACCORDO,
		new ColumnDescriptor(COL_DT_ATTO_ACCORDO, Types.TIMESTAMP, 7, false));
	map.put(COL_TI_SCOPO_ACCORDO,
		new ColumnDescriptor(COL_TI_SCOPO_ACCORDO, Types.VARCHAR, 20, false));
	...
	map.put(COL_DS_NOTA_RECESSO,
		new ColumnDescriptor(COL_DS_NOTA_RECESSO, Types.VARCHAR, 254, false));
	map.put(COL_DS_NOTA_FATTURAZIONE,
		new ColumnDescriptor(COL_DS_NOTA_FATTURAZIONE, Types.VARCHAR, 254, false));
	...
	map.put(COL_DT_FINE_VALID_ACCORDO,
		new ColumnDescriptor(COL_DT_FINE_VALID_ACCORDO, Types.TIMESTAMP, 7, false));
	map.put(COL_FL_ACCORDO_CHIUSO,
		new ColumnDescriptor(COL_FL_ACCORDO_CHIUSO, Types.VARCHAR, 1, false));
	map.put(COL_ID_CLUSTER_ACCORDO,
		new ColumnDescriptor(COL_ID_CLUSTER_ACCORDO, Types.DECIMAL, 22, false));
	map.put(COL_ID_FASCIA_STORAGE_STANDARD_ACCORDO, new ColumnDescriptor(
		COL_ID_FASCIA_STORAGE_STANDARD_ACCORDO, Types.DECIMAL, 22, false));
	map.put(COL_ID_FASCIA_STORAGE_MANUALE_ACCORDO, new ColumnDescriptor(
		COL_ID_FASCIA_STORAGE_MANUALE_ACCORDO, Types.DECIMAL, 22, false));
	map.put(COL_NI_TIPO_UD_STANDARD,
		new ColumnDescriptor(COL_NI_TIPO_UD_STANDARD, Types.DECIMAL, 22, false));
	map.put(COL_NI_TIPO_UD_MANUALE,
		new ColumnDescriptor(COL_NI_TIPO_UD_MANUALE, Types.DECIMAL, 22, false));
	map.put(COL_IM_ATTIV_DOC_AMM,
		new ColumnDescriptor(COL_IM_ATTIV_DOC_AMM, Types.DECIMAL, 22, false));
	map.put(COL_IM_ATTIV_DOC_SANI,
		new ColumnDescriptor(COL_IM_ATTIV_DOC_SANI, Types.DECIMAL, 22, false));
	map.put(COL_NI_REFERTI_STANDARD,
		new ColumnDescriptor(COL_NI_REFERTI_STANDARD, Types.DECIMAL, 22, false));
	map.put(COL_NI_REFERTI_MANUALE,
		new ColumnDescriptor(COL_NI_REFERTI_MANUALE, Types.DECIMAL, 22, false));
	map.put(COL_DS_NOTA_ATTIVAZIONE,
		new ColumnDescriptor(COL_DS_NOTA_ATTIVAZIONE, Types.VARCHAR, 254, false));
	map.put(COL_DS_NOTE_ENTE_ACCORDO,
		new ColumnDescriptor(COL_DS_NOTE_ENTE_ACCORDO, Types.VARCHAR, 254, false));
	map.put(COL_NI_STUDIO_DICOM,
		new ColumnDescriptor(COL_NI_STUDIO_DICOM, Types.DECIMAL, 22, false));
	map.put(COL_NI_STUDIO_DICOM_PREV,
		new ColumnDescriptor(COL_NI_STUDIO_DICOM_PREV, Types.DECIMAL, 22, false));
