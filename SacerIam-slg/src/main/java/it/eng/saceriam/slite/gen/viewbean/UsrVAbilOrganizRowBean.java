...
import it.eng.saceriam.viewEntity.UsrVAbilOrganizId;
 ...
 *
 */
public class UsrVAbilOrganizRowBean extends BaseRow
	...
	UsrVAbilOrganiz entity = (UsrVAbilOrganiz) obj;
	this.setIdUserIam(entity.getUsrVAbilOrganizId() == null ? null
		: entity.getUsrVAbilOrganizId().getIdUserIam());
	...
	this.setIdOrganizIam(entity.getUsrVAbilOrganizId() == null ? null
		: entity.getUsrVAbilOrganizId().getIdOrganizIam());
    ...
    @Override
    public UsrVAbilOrganiz rowBeanToEntity() {
	UsrVAbilOrganiz entity = new UsrVAbilOrganiz();
	entity.setUsrVAbilOrganizId(new UsrVAbilOrganizId());
	entity.getUsrVAbilOrganizId().setIdUserIam(this.getIdUserIam());
	...
	entity.getUsrVAbilOrganizId().setIdOrganizIam(this.getIdOrganizIam());
