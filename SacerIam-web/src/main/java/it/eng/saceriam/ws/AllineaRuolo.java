...
public class AllineaRuolo {
     ...
     *
     * @param nmSistemaChiamante nome sistema
     * @param nmUseridCor        userid
     * @param nmRuolo            nome ruolo
     * @param dsRuolo            descrizione ruolo
     * @param tiRuolo            tipo ruolo
     * @param listaCategRuolo    lista categorie di tipo {@link ListaCategRuolo}
     * @param listaApplic        lista applicazione di tipo {@link ListaApplic}
     *
     * @return Esito di risposta dell'allineamento
     *
     * @throws AuthWSException errore generico
     */
