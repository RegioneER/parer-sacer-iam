...
public class ModificaPswAction extends ActionBase {
    ...
    // Accetta tutte le stringhe che contengono almeno una lettera, almeno un numero ed almeno un
    // carattere speciale tra
	...
	if (!newpass.equals(confnewpass)) {
	    getMessageBox().addError(
		    "I campi nuova password e conferma nuova password non coincidono<br/>");
	}
	...
	if (!getMessageBox().hasError()) {
		...
		if (authEjb.userHasToChangePasswordFirstTime(param.getNomeUtente())) {
		    ...
		    param.setNomeAzione(
			    "button/AmministrazioneUtentiForm#EditPasswordUtente/salva_password");
		} else {
