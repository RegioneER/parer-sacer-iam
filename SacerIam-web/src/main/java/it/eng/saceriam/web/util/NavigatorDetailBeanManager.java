...
public class NavigatorDetailBeanManager {
    ...
    public static List<NavigatorDetailBean> pushNavigatorDetailStack(BigDecimal idObjectDetail,
	...
	navigatorDetailBeanStack
		.add(new NavigatorDetailBean(idObjectDetail, sourceList, sourceTable, level));
