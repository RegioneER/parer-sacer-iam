...
public class UserUtil {
    ...
    public static void fillComponenti(User utente, RecuperoAutorizzazioniRisposta auth) {
        ...
        for (it.eng.saceriam.ws.dto.RecuperoAutorizzazioniRisposta.Pagina aplPagina : auth.getPagineList()) {
            aplMap.put(aplPagina.getNmPaginaWeb(), new ArrayList<String>());
        }
        for (it.eng.saceriam.ws.dto.RecuperoAutorizzazioniRisposta.Azione aplAzione : auth.getAzioniList()) {
        ...
        for (String nmPaginaWeb : aplMap.keySet()) {
            ...
            for (it.eng.saceriam.ws.dto.RecuperoAutorizzazioniRisposta.Menu entryMenu : auth.getMenuList()) {
    ...
    public static Menu populateMenu(List<it.eng.saceriam.ws.dto.RecuperoAutorizzazioniRisposta.Menu> userMenu) {
        Menu menu = new Menu("", "");
