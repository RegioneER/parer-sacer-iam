...
public class ApplicationBasePropertiesSeviceImpl implements IApplicationBasePropertiesSevice {
    ...
    public ApplicationBaseProperties getApplicationBaseProperties() {
        String nmApplic = paramHelper.getValoreParamApplicByApplic(ConstIamParamApplic.NmParamApplic.NM_APPLIC.name()); // NM_APPLIC
        String user = paramHelper
                .getValoreParamApplicByApplic(ConstIamParamApplic.NmParamApplic.USERID_RECUP_INFO.name());
        String password = paramHelper
                .getValoreParamApplicByApplic(ConstIamParamApplic.NmParamApplic.PSW_RECUP_INFO.name());
        String url = paramHelper.getValoreParamApplicByApplic(ConstIamParamApplic.NmParamApplic.URL_RECUP_HELP.name());
