...
public class NoteRilascioAction extends NoteRilascioAbstractAction {
    ...
    public void loadDettaglio() throws EMFError {
        ...
        if (lista != null) {
            ...
            if (lista.equals(getForm().getListaNoteRilascio().getName())) {
                ...
                if (!((AplNotaRilascioTableBean) getForm().getListaNoteRilascio().getTable()).isEmpty()) {
                    BigDecimal idNotaRilascio = ((AplNotaRilascioTableBean) getForm().getListaNoteRilascio().getTable())
                            .getCurrentRow().getIdNotaRilascio();
                    AplNotaRilascioRowBean detailRow = noteRilascioEjb.getAplNotaRilascioRowBean(idNotaRilascio);
    ...
    public void ricercaNoteRilascio(String nmApplic) throws EMFError {
        ...
        AplNotaRilascioTableBean noteRilascioTableBean = noteRilascioEjb.getAplNoteRilascioTableBean(nmApplic);
