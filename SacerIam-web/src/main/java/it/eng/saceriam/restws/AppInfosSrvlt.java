...
public class AppInfosSrvlt extends HttpServlet {
    ...
    @EJB
    private ControlliRestWS myControlliWs;
    ...
    private boolean isUserAuthenticated(String authString, String ipAddr) {
        ...
        // check credentials
        RispostaControlli rs = myControlliWs.checkCredenzialiEAuth(loginName, pwd, ipAddr, new IWSDesc() {
            @Override
            public String getNomeWs() {
                return Costanti.WS_APPINFO_NOME;
            }

            @Override
            public String getVersione() {
                return Costanti.WS_APPINFO_VRSN;
            }

            @Override
            public String[] getCompatibilitaWS() {
                return Costanti.WS_APPINFO_COMP;
            }
        });
