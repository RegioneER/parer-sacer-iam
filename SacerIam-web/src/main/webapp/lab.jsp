<%--
    Document   : index
    Created on : 15-apr-2014, 15.56.16
    Author     : Gilioli_P fregated at 40_M
--%>
    ...
    <body>
        ...
        <div class="tabbed">
            ...
            <div id="others" class="tab">
                <a href="TimerReplicaUtenti.jsp">Lancia replica utenti...</a>
                <br/>
                <a href="Status.jsp">Lancia il recupero dello status dell'applicazione...</a>
                <br/>
            </div>
