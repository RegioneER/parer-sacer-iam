...
<sl:html>
    ...
    <sl:body>
        ...
        <sl:content>
            ...
            <slf:fieldSet>
                <slf:lblField name="<%= AmministrazioneEntiConvenzionatiForm.Configuration.TI_PARAM_APPLIC_COMBO%>" colSpan="2" /><sl:newLine/>
                <slf:lblField name="<%= AmministrazioneEntiConvenzionatiForm.Configuration.TI_GESTIONE_PARAM_COMBO%>" colSpan="2" /><sl:newLine/>
            ...
            <sl:newLine skipLine="true"/>
            <slf:list name="<%= AmministrazioneEntiConvenzionatiForm.ConfigurationList.NAME%>" />
