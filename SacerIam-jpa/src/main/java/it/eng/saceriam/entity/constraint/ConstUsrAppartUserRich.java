...
public class ConstUsrAppartUserRich {
    ...
    // public static String[] tiAzioneRich = {"Richiesta di cessazione", "Richiesta di creazione",
    // "Richiesta di
    // modifica abilitazioni", "Richiesta di riattivazione"};
    public enum TiAzioneRich {
	RICHIESTA_CESSAZIONE("Richiesta di cessazione"),
	RICHIESTA_CREAZIONE("Richiesta di creazione"),
	RICHIESTA_MODIFICA_ABILITAZIONI("Richiesta di modifica abilitazioni"),
	RICHIESTA_RIATTIVZIONE("Richiesta di riattivazione"),
	RICHIESTA_RESET_PWD("Richiesta di reset password"),
	...
	public static TiAzioneRich[] getListaEnumNonConvenz() {
	    return getEnums(RICHIESTA_CESSAZIONE, RICHIESTA_CREAZIONE, RICHIESTA_RIATTIVZIONE,
		    RICHIESTA_RESET_PWD, RICHIESTA_MODIFICA_ENTE_APPARTENENZA,
	...
	public static TiAzioneRich[] getListaEnumConvenz() {
	    return getEnums(RICHIESTA_CESSAZIONE, RICHIESTA_CREAZIONE, RICHIESTA_RIATTIVZIONE,
		    RICHIESTA_RESET_PWD, RICHIESTA_MODIFICA_ENTE_APPARTENENZA,
		    RICHIESTA_MODIFICA_ABILITAZIONI, RICHIESTA_MODIFICA_ANAGRAFICA,
		    RICHIESTA_DISATTIVAZIONE);
	}
    }
