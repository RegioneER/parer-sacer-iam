 ...
 * @author Gilioli_P
 */
public class ConstOrgEnteSiam {

    private ConstOrgEnteSiam() {
    }
    ...
    /**
     * Tipo ente non convenzionato ti_ente_non_convenz IN ('FORNITORE_ESTERNO', 'SOGGETTO_ATTUATORE',
     * 'ORGANO_VIGILANZA', 'VERSATORE_ESTERNO')
     */
