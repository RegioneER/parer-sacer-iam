...
@Embeddable()
public class UsrVUnenteByAmminId implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 29 * hash + Objects.hashCode(this.idEnteConvenz);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVUnenteByAmminId other = (UsrVUnenteByAmminId) obj;
