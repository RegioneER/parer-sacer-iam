...
@Embeddable()
public class UsrVLisUserXstrutId implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 31 * hash + Objects.hashCode(this.idOrganizApplic);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVLisUserXstrutId other = (UsrVLisUserXstrutId) obj;
