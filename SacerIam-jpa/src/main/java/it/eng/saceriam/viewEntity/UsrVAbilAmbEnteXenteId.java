...
@Embeddable()
public class UsrVAbilAmbEnteXenteId implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 43 * hash + Objects.hashCode(this.idAmbienteEnteConvenz);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVAbilAmbEnteXenteId other = (UsrVAbilAmbEnteXenteId) obj;
