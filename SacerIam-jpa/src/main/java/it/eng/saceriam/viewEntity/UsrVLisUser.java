...
@NamedQuery(name = "UsrVLisUser.findAll", query = "SELECT u FROM UsrVLisUser u")
public class UsrVLisUser implements Serializable {
    ...
    public UsrVLisUser(BigDecimal idUserIam, String nmCognomeUser, String nmNomeUser, String nmUserid, String cdFisc,
            String nmRuoloDefault, String flAttivo, String flErrReplic, String nmSistemaVersante, String tipoUser,
            String nmEnteSiamAppart, BigDecimal idLastRichGestUser, String cdLastRichGestUser, String dsListaAzioni,
            Date dtLastRichGestUser, String flAzioniEvase, String dsEmail, String dsEmailSecondaria) {
