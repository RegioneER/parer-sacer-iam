...
@Embeddable()
public class UsrVUnaorgByVigilId implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + Objects.hashCode(this.idOrganizIamStrut);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVUnaorgByVigilId other = (UsrVUnaorgByVigilId) obj;
