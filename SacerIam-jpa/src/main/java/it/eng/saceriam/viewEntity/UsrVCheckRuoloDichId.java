...
@Embeddable()
public class UsrVCheckRuoloDichId implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 37 * hash + Objects.hashCode(this.idAutorAggiunta);
        hash = 37 * hash + Objects.hashCode(this.idRuoloAggiunto);
        hash = 37 * hash + Objects.hashCode(this.idUserCorrente);
        hash = 37 * hash + Objects.hashCode(this.tiDichAutor);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVCheckRuoloDichId other = (UsrVCheckRuoloDichId) obj;
