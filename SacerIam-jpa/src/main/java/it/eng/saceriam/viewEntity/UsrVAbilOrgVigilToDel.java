...
/**
 * The persistent class for the USR_V_ABIL_ORG_VIGIL_TO_DEL database table.
 * 
 */
@Entity
@Table(name = "USR_V_ABIL_ORG_VIGIL_TO_DEL")
@NamedQuery(name = "UsrVAbilOrgVigilToDel.findAll", query = "SELECT u FROM UsrVAbilOrgVigilToDel u")
public class UsrVAbilOrgVigilToDel implements Serializable {
