...
@Embeddable()
public class UsrVUnaorgByGestoreId implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 71 * hash + Objects.hashCode(this.idOrganizIam);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVUnaorgByGestoreId other = (UsrVUnaorgByGestoreId) obj;
