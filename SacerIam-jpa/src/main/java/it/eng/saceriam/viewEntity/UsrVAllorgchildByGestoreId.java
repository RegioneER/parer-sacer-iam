...
@Embeddable()
public class UsrVAllorgchildByGestoreId implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 29 * hash + Objects.hashCode(this.idOrganizIamAmbEnte);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVAllorgchildByGestoreId other = (UsrVAllorgchildByGestoreId) obj;
