...
@Embeddable()
public class UsrVUnaorgByFornitCorId implements Serializable {
    ...
    public int hashCode() {
	int hash = 5;
	hash = 97 * hash + Objects.hashCode(this.idOrganizIamStrut);
	...
	final UsrVUnaorgByFornitCorId other = (UsrVUnaorgByFornitCorId) obj;
