...
public class UsrVRicRichieste implements Serializable {
    ...
    public UsrVRicRichieste(BigDecimal idRichGestUser, String nmAmbienteEnteConvenz,
	    String nmEnteSiam, String dlCompositoOrganiz, String cdRegistroRichGestUser,
	    BigDecimal aaRichGestUser, String cdKeyRichGestUser, String cdRichGestUser,
	    String nmCognomeUserRich, String nmNomeUserRich, String nmUserRich, Date dtRichGestUser,
