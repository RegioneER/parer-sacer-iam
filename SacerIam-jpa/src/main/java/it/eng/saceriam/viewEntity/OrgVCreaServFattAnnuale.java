...
/**
 * The persistent class for the ORG_V_CREA_SERV_FATT_ANNUALE database table.
 */
@Entity
@Table(name = "ORG_V_CREA_SERV_FATT_ANNUALE")
@NamedQuery(name = "OrgVCreaServFattAnnuale.findAll", query = "SELECT o FROM OrgVCreaServFattAnnuale o")
public class OrgVCreaServFattAnnuale implements Serializable {
    ...
    public OrgVCreaServFattAnnuale() {
    ...
    private OrgVCreaServFattAnnualeId orgVCreaServFattAnnualeId;

    @EmbeddedId()
    public OrgVCreaServFattAnnualeId getOrgVCreaServFattAnnualeId() {
        return orgVCreaServFattAnnualeId;
    }

    public void setOrgVCreaServFattAnnualeId(OrgVCreaServFattAnnualeId orgVCreaServFattAnnualeId) {
        this.orgVCreaServFattAnnualeId = orgVCreaServFattAnnualeId;
    }
}
