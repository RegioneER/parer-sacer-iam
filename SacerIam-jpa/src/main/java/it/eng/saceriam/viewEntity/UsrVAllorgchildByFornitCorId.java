...
@Embeddable()
public class UsrVAllorgchildByFornitCorId implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 83 * hash + Objects.hashCode(this.idOrganizIamEnte);
        hash = 83 * hash + Objects.hashCode(this.idUserIamCor);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVAllorgchildByFornitCorId other = (UsrVAllorgchildByFornitCorId) obj;
