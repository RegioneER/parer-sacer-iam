...
@Embeddable()
public class UsrVAllorgchildByFornitId implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 17 * hash + Objects.hashCode(this.idOrganizIamEnte);
        hash = 17 * hash + Objects.hashCode(this.idUserIamCor);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVAllorgchildByFornitId other = (UsrVAllorgchildByFornitId) obj;
