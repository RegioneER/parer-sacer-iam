...
public class AplVRicSistemaVersante implements Serializable {
    ...
    public AplVRicSistemaVersante(BigDecimal idSistemaVersante, String nmSistemaVersante, String dsSistemaVersante,
            String nmProduttore, String dsEmail, String flPec, String flCessato, String flIntegrazione,
            String flAssociaPersonaFisica, String archivista) {
    ...
    public AplVRicSistemaVersante(BigDecimal idSistemaVersante, String nmSistemaVersante, String dsSistemaVersante,
            String cdVersione, String nmEnteSiam, String flIntegrazione, String flAssociaPersonaFisica, String dsEmail,
            String flPec, String cdCapSedeLegale, String dsCittaSedeLegale, String dsViaSedeLegale,
            BigDecimal idEnteSiam, Date dtIniVal, Date dtFineVal, String dsNote) {
        this.aplVRicSistemaVersanteId = new AplVRicSistemaVersanteId();
        this.aplVRicSistemaVersanteId.setIdSistemaVersante(idSistemaVersante);
        this.nmSistemaVersante = nmSistemaVersante;
        this.dsSistemaVersante = dsSistemaVersante;
