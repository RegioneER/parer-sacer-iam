...
public class OrgVRicFatture implements Serializable {
    ...
    public OrgVRicFatture(String cdFattura, BigDecimal aaEmissFattura, BigDecimal aaFattura,
	    String cdEmisFattura, String cdRegistroEmisFattura, String cdTipoAccordo,
	    Date dtEmisFattura, Date dtRegStatoFatturaEnte, BigDecimal idAccordoEnte,
	    BigDecimal idEnteConvenz, BigDecimal idFatturaEnte, BigDecimal idStatoFatturaEnte,
	    BigDecimal idTipoAccordo, BigDecimal imTotFattura, String nmEnteConvenz,
    ...
    public OrgVRicFatture(BigDecimal idEnteConvenz, String nmEnteConvenz, String cdFattura,
	    String cdEmisFattura, Date dtEmisFattura, String tiStatoFatturaEnte,
