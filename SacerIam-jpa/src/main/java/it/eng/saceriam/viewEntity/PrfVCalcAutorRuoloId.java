...
@Embeddable()
public class PrfVCalcAutorRuoloId implements Serializable {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 11 * hash + Objects.hashCode(this.idApplic);
        hash = 11 * hash + Objects.hashCode(this.idAutor);
        hash = 11 * hash + Objects.hashCode(this.idRuolo);
        hash = 11 * hash + Objects.hashCode(this.tiDichAutor);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final PrfVCalcAutorRuoloId other = (PrfVCalcAutorRuoloId) obj;
