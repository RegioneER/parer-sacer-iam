...
@Embeddable()
public class PrfVAutorRuoloId implements Serializable {
    ...
    public int hashCode() {
	int hash = 7;
	hash = 83 * hash + Objects.hashCode(this.idApplic);
	hash = 83 * hash + Objects.hashCode(this.idAutor);
	hash = 83 * hash + Objects.hashCode(this.idRuolo);
	hash = 83 * hash + Objects.hashCode(this.tiDichAutor);
	return hash;
    }
	...
	final PrfVAutorRuoloId other = (PrfVAutorRuoloId) obj;
