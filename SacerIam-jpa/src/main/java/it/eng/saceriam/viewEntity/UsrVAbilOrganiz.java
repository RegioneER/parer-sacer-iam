...
/**
 * The persistent class for the USR_V_ABIL_ORGANIZ database table.
 */
@Entity
@Table(name = "USR_V_ABIL_ORGANIZ")
public class UsrVAbilOrganiz implements Serializable {
    ...
    public UsrVAbilOrganiz() {
    }

    public UsrVAbilOrganiz(BigDecimal idOrganizIam, BigDecimal idOrganizApplic) {
	this.usrVAbilOrganizId = new UsrVAbilOrganizId();
	this.usrVAbilOrganizId.setIdOrganizIam(idOrganizIam);
    ...
    private UsrVAbilOrganizId usrVAbilOrganizId;

    @EmbeddedId()
    public UsrVAbilOrganizId getUsrVAbilOrganizId() {
	return usrVAbilOrganizId;
    }

    public void setUsrVAbilOrganizId(UsrVAbilOrganizId usrVAbilOrganizId) {
	this.usrVAbilOrganizId = usrVAbilOrganizId;
    }
}
