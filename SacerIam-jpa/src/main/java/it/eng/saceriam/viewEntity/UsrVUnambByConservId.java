...
@Embeddable()
public class UsrVUnambByConservId implements Serializable {
    ...
    public int hashCode() {
	int hash = 5;
	hash = 89 * hash + Objects.hashCode(this.idAmbienteEnteConvenz);
	...
	final UsrVUnambByConservId other = (UsrVUnambByConservId) obj;
