...
@Embeddable()
public class UsrVAllorgchildByVigilId implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 41 * hash + Objects.hashCode(this.idOrganizIamEnte);
        hash = 41 * hash + Objects.hashCode(this.idUserIamCor);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVAllorgchildByVigilId other = (UsrVAllorgchildByVigilId) obj;
