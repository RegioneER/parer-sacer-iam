...
/**
 * The persistent class for the ORG_V_RIC_FATTURE_PER_ACCORDO database table.
 *
 */
@Entity
@Table(name = "ORG_V_RIC_FATTURE_PER_ACCORDO")
@NamedQuery(name = "OrgVRicFatturePerAccordo.findAll", query = "SELECT a FROM OrgVRicFatturePerAccordo a")
public class OrgVRicFatturePerAccordo implements Serializable {
    ...
    public OrgVRicFatturePerAccordo() {
    }

    public OrgVRicFatturePerAccordo(String cdFattura, BigDecimal aaEmissFattura, BigDecimal aaFattura,
            String cdEmisFattura, String cdRegistroEmisFattura, String cdTipoAccordo, Date dtEmisFattura,
            Date dtRegStatoFatturaEnte, BigDecimal idAccordoEnte, BigDecimal idEnteConvenz, BigDecimal idFatturaEnte,
            BigDecimal idStatoFatturaEnte, BigDecimal idTipoAccordo, BigDecimal imTotFattura, String nmEnteConvenz,
            BigDecimal pgFattura, String tiStatoFatturaEnte, BigDecimal imTotPagato) {
    ...
    public OrgVRicFatturePerAccordo(BigDecimal idEnteConvenz, String nmEnteConvenz, String cdFattura,
            String cdEmisFattura, Date dtEmisFattura, String tiStatoFatturaEnte, Date dtRegStatoFatturaEnte,
            BigDecimal idFatturaEnte, BigDecimal imTotFattura, BigDecimal imTotPagato) {
        this.cdFattura = cdFattura;
        this.cdEmisFattura = cdEmisFattura;
        this.dtEmisFattura = dtEmisFattura;
        this.dtRegStatoFatturaEnte = dtRegStatoFatturaEnte;
