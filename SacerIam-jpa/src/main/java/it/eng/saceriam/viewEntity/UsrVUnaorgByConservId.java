...
@Embeddable()
public class UsrVUnaorgByConservId implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 17 * hash + Objects.hashCode(this.idOrganizIam);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVUnaorgByConservId other = (UsrVUnaorgByConservId) obj;
