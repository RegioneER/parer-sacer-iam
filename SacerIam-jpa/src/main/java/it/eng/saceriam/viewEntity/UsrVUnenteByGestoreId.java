...
@Embeddable()
public class UsrVUnenteByGestoreId implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 67 * hash + Objects.hashCode(this.idEnteConvenz);
    ...
    public boolean equals(Object obj) {
        ...
        final UsrVUnenteByGestoreId other = (UsrVUnenteByGestoreId) obj;
