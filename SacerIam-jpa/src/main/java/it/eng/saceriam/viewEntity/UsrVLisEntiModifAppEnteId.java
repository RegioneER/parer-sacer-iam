...
@Embeddable()
public class UsrVLisEntiModifAppEnteId implements Serializable {
    ...
    public int hashCode() {
	int hash = 7;
	hash = 89 * hash + Objects.hashCode(this.idEnteSiam);
	...
	final UsrVLisEntiModifAppEnteId other = (UsrVLisEntiModifAppEnteId) obj;
